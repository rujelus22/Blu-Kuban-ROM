...
function initReader() {
	...
	//	reader_div.appendChild(reader_script);
		var reader_css = document.createElement('style');
		reader_css.type = 'text/css';
		reader_css.textContent = ".page {border: 1px solid #c4d1d0;margin:10px 0px 10px 2px;padding:2px;word-wrap:break-word; }.page-separator {font-size:10px;text-align:right;width:95%;color:#94acaa;padding-top:10px}.page-num {font-size:10px;color:#94acaa}.page-total {font-size:10px;color:#94acaa}";
...
// sample = nextPageLink
//		
//		allPageLink= nextPageLink;
//		while (nextPageLink) {
//			
//			if(nextPageLink != allPageLink)
//			allPageLink = allPageLink+","+ nextPageLink;
//			nextPageLink = findNextPageLink(document.body);
//				
//		}	
//		 var len = window.location.href;
//		 var val =len.indexOf("//");
//		var protocol= len.substring(0,val);
//		alert("protocol" + protocol);
//		var  nxt = len.lastIndexOf("/");
//		 var host = len.substring(val+2,nxt);
//		 alert("host" + host);
//		 var path = len.substring(nxt, len.length);
//		 alert("path" + path);
        var parameters;
		if(nextPageLink) {
		...
		reader_content_div.innerHTML = "<div id='readability-page-1' class='page'><p class='page-separator' title='No Page'></p>"+article_block+"</div>";
		}
		else {
		//reader_content_div.innerHTML = "<div id='readability-page-1' class='page'><p class='page-separator' title='Page1'>Page 1</p>"+article_block+"</div>";
		//To update the total number of pages
		reader_content_div.innerHTML = '<div id="readability-page-1" class="page"><div class="page-separator"><span class="page-num" title="Page ' + curPageNum + '">Page '+curPageNum+' of </span><span id="page" class="page-total">'+totalPageNum+'</span></div>'+article_block+'</div>';
		
		
		}		
                //reader_content_div.innerHTML = "<div id='readability-page-1' class='page' style='border: 1px solid #c4d1d0;margin:10px 0px 10px 2px;padding:2px; '><p class='page-separator' title='Page1'>Page 1</p>"+article_block+"</div>";
		reader_div.appendChild(reader_content_div);
		reader_content_div.outerHTML += parameters;
	//	reader_content_div.outerHTML += allPageLink;
