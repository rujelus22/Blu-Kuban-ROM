...
.field private mNonOverScrollOffsetX:F

.field private mNonOverScrollOffsetY:F
...
.method private drawingOffsetX()F
    .registers 2

    .prologue
    .line 243
    iget-boolean v0, p0, Lcom/google/android/opengl/glview/Transformer;->mTiltingOverscroll:Z

    if-eqz v0, :cond_7

    iget v0, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetX:F
...
.method private drawingOffsetY()F
    .registers 2
    ...
    iget v0, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetY:F
...
.method public adjustOffset(FF)V
    ...
    iput v4, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetX:F
    ...
    iput v4, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetY:F
...
.method public convertFromParent(Landroid/graphics/RectF;)V
    ...
    .prologue
    .line 231
    invoke-direct {p0}, Lcom/google/android/opengl/glview/Transformer;->drawingOffsetX()F

    move-result v0

    .line 232
    .local v0, ox:F
    invoke-direct {p0}, Lcom/google/android/opengl/glview/Transformer;->drawingOffsetY()F
...
.method public onDrawFrame(Lcom/google/android/opengl/glview/GLCanvas;F)Z
    ...
    iget v4, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetX:F
    ...
    iget v4, p0, Lcom/google/android/opengl/glview/Transformer;->mNonOverScrollOffsetY:F
