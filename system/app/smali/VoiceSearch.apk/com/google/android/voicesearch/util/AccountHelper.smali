...
.method private getAccounts(Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/voicesearch/util/AccountHelper;->getSyncedAccounts(Ljava/lang/String;)[Landroid/accounts/Account;
    :try_end_12
    .catch Landroid/accounts/AuthenticatorException; {:try_start_a .. :try_end_12} :catch_14
    .catch Landroid/accounts/OperationCanceledException; {:try_start_a .. :try_end_12} :catch_1e
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_12} :catch_28
...
.method private getAuthToken(Landroid/accounts/Account;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_26
    .catch Landroid/accounts/OperationCanceledException; {:try_start_17 .. :try_end_26} :catch_27
    .catch Landroid/accounts/AuthenticatorException; {:try_start_17 .. :try_end_26} :catch_38
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_26} :catch_41
    ...
    :try_end_36
    .catch Landroid/accounts/OperationCanceledException; {:try_start_31 .. :try_end_36} :catch_27
    .catch Landroid/accounts/AuthenticatorException; {:try_start_31 .. :try_end_36} :catch_38
...
.method public getGmailAccountsBlocking(Landroid/content/Context;)[Landroid/accounts/Account;
    ...
    :try_end_1d
    .catch Landroid/accounts/OperationCanceledException; {:try_start_17 .. :try_end_1d} :catch_1e
    .catch Landroid/accounts/AuthenticatorException; {:try_start_17 .. :try_end_1d} :catch_28
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_1d} :catch_31
