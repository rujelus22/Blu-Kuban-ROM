...
.method private getWifiSupplicant(Ljava/lang/String;)[B
    ...
    sget-object v6, Lcom/android/providers/settings/SettingsBackupAgent;->EMPTY_DATA:[B
    :try_end_68
    .catch Ljava/io/IOException; {:try_start_54 .. :try_end_68} :catch_38
...
.method private readOldChecksums(Landroid/os/ParcelFileDescriptor;)[J
    ...
    aput-wide v4, v2, v1
    :try_end_21
    .catch Ljava/io/EOFException; {:try_start_11 .. :try_end_21} :catch_24
...
.method private restoreSettings(Landroid/app/backup/BackupDataInput;Landroid/net/Uri;)V
    ...
    invoke-virtual {p1, v6, v9, v10}, Landroid/app/backup/BackupDataInput;->readEntityData([BII)I
    :try_end_1d
    .catch Ljava/io/IOException; {:try_start_19 .. :try_end_1d} :catch_77
    ...
    invoke-direct {v4, v6, v3, v2}, Ljava/lang/String;-><init>([BII)V
    ...
    invoke-direct {v5, v6, v3, v2}, Ljava/lang/String;-><init>([BII)V
    ...
    invoke-virtual {v9, v4, v5}, Lcom/android/providers/settings/SettingsHelper;->restoreValue(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v9, p2, v0}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
