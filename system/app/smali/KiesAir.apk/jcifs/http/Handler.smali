...
.method private static getDefaultStreamHandler(Ljava/lang/String;)Ljava/net/URLStreamHandler;
    ...
    .prologue
    .line 103
    sget-object v10, Ljcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;

    monitor-enter v10

    .line 104
    :try_start_3
    sget-object v9, Ljcifs/http/Handler;->PROTOCOL_HANDLERS:Ljava/util/Map;
    ...
    :cond_10
    sget-object v9, Ljcifs/http/Handler;->factory:Ljava/net/URLStreamHandlerFactory;
    ...
    :try_end_5b
    .catchall {:try_start_3 .. :try_end_5b} :catchall_d0
    ...
    .catch Ljava/lang/Exception; {:try_start_5d .. :try_end_60} :catch_df
    ...
    move-object v2, v0
    :try_end_73
    .catchall {:try_start_63 .. :try_end_73} :catchall_d0
    .catch Ljava/lang/Exception; {:try_start_63 .. :try_end_73} :catch_e5
    ...
    :goto_76
    :try_start_76
    sget-object v9, Ljcifs/http/Handler;->JVM_VENDOR_DEFAULT_PKGS:[Ljava/lang/String;
    ...
    sget-object v11, Ljcifs/http/Handler;->JVM_VENDOR_DEFAULT_PKGS:[Ljava/lang/String;
    ...
    invoke-virtual {v9}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    :try_end_9b
    .catchall {:try_start_76 .. :try_end_9b} :catchall_d0
    ...
    .catch Ljava/lang/Exception; {:try_start_9d .. :try_end_a0} :catch_e1
    ...
    move-object v2, v0
    :try_end_b3
    .catchall {:try_start_a3 .. :try_end_b3} :catchall_d0
    .catch Ljava/lang/Exception; {:try_start_a3 .. :try_end_b3} :catch_e3
    ...
    monitor-exit v10
    :try_end_dc
    .catchall {:try_start_d6 .. :try_end_dc} :catchall_d0
...
.method protected openConnection(Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    new-instance v2, Ljcifs/http/NtlmHttpURLConnection;
    ...
    invoke-direct {v2, v1}, Ljcifs/http/NtlmHttpURLConnection;-><init>(Ljava/net/HttpURLConnection;)V
