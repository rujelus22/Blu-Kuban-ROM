...
.method private static copyData(Ljava/util/HashMap;Lorg/json/JSONStringer;[Lcom/google/android/gsf/login/BackendStub$Key;)V
    ...
    :try_end_2d
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_2d} :catch_30
...
.method public checkLoginNameSync(Landroid/content/Context;Lcom/google/android/gsf/loginservice/GLSUser$GLSSession;Landroid/os/Message;Ljava/util/concurrent/atomic/AtomicBoolean;)Lcom/google/android/gsf/loginservice/GLSUser$Status;
    ...
    :try_end_43
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_43} :catch_e7
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_43} :catch_f4
    ...
    :try_end_7a
    .catch Ljava/io/IOException; {:try_start_46 .. :try_end_7a} :catch_7f
    .catch Lorg/json/JSONException; {:try_start_46 .. :try_end_7a} :catch_e7
    .catch Ljava/lang/IllegalArgumentException; {:try_start_46 .. :try_end_7a} :catch_f4
    ...
    :try_end_e6
    .catch Lorg/json/JSONException; {:try_start_7c .. :try_end_e6} :catch_e7
    .catch Ljava/lang/IllegalArgumentException; {:try_start_7c .. :try_end_e6} :catch_f4
...
.method public createAccountSync(Landroid/content/Context;Lcom/google/android/gsf/loginservice/GLSUser$GLSSession;)Lcom/google/android/gsf/loginservice/GLSUser$Status;
    ...
    if-ne v10, v4, :cond_119

    .line 393
    invoke-static {v5, v9}, Lcom/google/android/gsf/login/BackendStub;->copyCaptchaData(Lorg/json/JSONObject;Ljava/util/HashMap;)V
    :try_end_10b
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_10b} :catch_10c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_10b} :catch_133
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_10b} :catch_13e
    ...
    :try_end_11b
    .catch Lorg/json/JSONException; {:try_start_119 .. :try_end_11b} :catch_10c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_119 .. :try_end_11b} :catch_133
    .catch Ljava/io/IOException; {:try_start_119 .. :try_end_11b} :catch_13e
    ...
    :try_end_130
    .catch Lorg/json/JSONException; {:try_start_11d .. :try_end_130} :catch_131
    .catch Ljava/lang/IllegalArgumentException; {:try_start_11d .. :try_end_130} :catch_133
    .catch Ljava/io/IOException; {:try_start_11d .. :try_end_130} :catch_13e
...
.method public ratePasswordSync(Landroid/content/Context;Lcom/google/android/gsf/loginservice/GLSUser$GLSSession;Landroid/os/Message;)Lcom/google/android/gsf/loginservice/GLSUser$Status;
    ...
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_83} :catch_91
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_83} :catch_9c
