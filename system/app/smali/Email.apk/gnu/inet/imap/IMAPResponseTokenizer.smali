...
.method public next()Lgnu/inet/imap/IMAPResponse;
    ...
    :try_end_b3
    .catch Ljava/lang/NumberFormatException; {:try_start_ad .. :try_end_b3} :catch_be
    ...
    if-eq v13, v1, :cond_13e

    const/16 v1, 0x5b

    if-ne v13, v1, :cond_153
    ...
    if-eq v13, v1, :cond_1db

    const/16 v1, 0x5b

    if-ne v13, v1, :cond_216
    ...
    if-eq v13, v1, :cond_21e

    const/16 v1, 0x5d

    if-ne v13, v1, :cond_246
    ...
    :try_end_2c4
    .catch Ljava/lang/NumberFormatException; {:try_start_2c1 .. :try_end_2c4} :catch_2cf
