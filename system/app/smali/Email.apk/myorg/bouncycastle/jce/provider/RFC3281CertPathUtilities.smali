...
.method private static checkCRL(Lmyorg/bouncycastle/asn1/x509/DistributionPoint;Lmyorg/bouncycastle/x509/X509AttributeCertificate;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lmyorg/bouncycastle/jce/provider/CertStatus;Lmyorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;)V
    ...
    :try_end_f1
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_52 .. :try_end_f1} :catch_b0
...
.method protected static checkCRLs(Lmyorg/bouncycastle/x509/X509AttributeCertificate;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/util/List;)V
    ...
    :try_end_1c
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_11 .. :try_end_1c} :catch_60
    ...
    :try_end_22
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_1d .. :try_end_22} :catch_69
    ...
    :try_end_35
    .catch Ljava/lang/Exception; {:try_start_32 .. :try_end_35} :catch_72
    ...
    :try_end_5b
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_37 .. :try_end_5b} :catch_7b
    ...
    :try_end_ab
    .catch Ljava/lang/Exception; {:try_start_92 .. :try_end_ab} :catch_e4
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_92 .. :try_end_ab} :catch_ed
    ...
    invoke-static/range {v1 .. v8}, Lmyorg/bouncycastle/jce/provider/RFC3281CertPathUtilities;->checkCRL(Lmyorg/bouncycastle/asn1/x509/DistributionPoint;Lmyorg/bouncycastle/x509/X509AttributeCertificate;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lmyorg/bouncycastle/jce/provider/CertStatus;Lmyorg/bouncycastle/jce/provider/ReasonsMask;Ljava/util/List;)V
    :try_end_d8
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_ac .. :try_end_d8} :catch_ed
    ...
    throw v2
    :try_end_ed
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_e5 .. :try_end_ed} :catch_ed
...
.method protected static processAttrCert1(Lmyorg/bouncycastle/x509/X509AttributeCertificate;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;)Ljava/security/cert/CertPath;
    ...
    :try_end_48
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_2c .. :try_end_48} :catch_4b
    .catch Ljava/io/IOException; {:try_start_2c .. :try_end_48} :catch_54
    ...
    invoke-interface {v2, v10}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z
    :try_end_a2
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_86 .. :try_end_a2} :catch_a5
    .catch Ljava/io/IOException; {:try_start_86 .. :try_end_a2} :catch_ae
    ...
    :try_end_ef
    .catch Ljava/security/NoSuchProviderException; {:try_start_e8 .. :try_end_ef} :catch_f9
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_e8 .. :try_end_ef} :catch_102
    ...
    :try_end_f7
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_f0 .. :try_end_f7} :catch_10b
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_f0 .. :try_end_f7} :catch_114
...
.method protected static processAttrCert7(Lmyorg/bouncycastle/x509/X509AttributeCertificate;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;)V
    ...
    :try_end_15
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_c .. :try_end_15} :catch_32
    .catch Ljava/lang/IllegalArgumentException; {:try_start_c .. :try_end_15} :catch_3b
