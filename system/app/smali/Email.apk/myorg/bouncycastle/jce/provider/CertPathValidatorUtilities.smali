...
.method protected static final findCRLs(Lmyorg/bouncycastle/x509/X509CRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_end_23
    .catch Lmyorg/bouncycastle/util/StoreException; {:try_start_1c .. :try_end_23} :catch_25
...
.method protected static findCertificates(Lmyorg/bouncycastle/x509/X509AttributeCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    :try_end_21
    .catch Lmyorg/bouncycastle/util/StoreException; {:try_start_1a .. :try_end_21} :catch_22
...
.method protected static findIssuerCerts(Ljava/security/cert/X509Certificate;Lmyorg/bouncycastle/x509/ExtendedPKIXBuilderParameters;)Ljava/util/Collection;
    ...
    :try_end_15
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_15} :catch_4f
    ...
    :try_end_3e
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_15 .. :try_end_3e} :catch_58
...
.method protected static getCompleteCRLs(Lmyorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;)Ljava/util/Set;
    ...
    :try_end_24
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_6 .. :try_end_24} :catch_a4
    ...
    invoke-interface {v2, v7}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z
    :try_end_65
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_44 .. :try_end_65} :catch_bf
    ...
    invoke-interface {v5, v7}, Ljava/util/Set;->add(Ljava/lang/Object;)Z
    :try_end_a2
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_9b .. :try_end_a2} :catch_a4
...
.method protected static getDeltaCRLs(Ljava/util/Date;Lmyorg/bouncycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/X509CRL;)Ljava/util/Set;
    ...
    :try_end_2d
    .catch Ljava/lang/Exception; {:try_start_1e .. :try_end_2d} :catch_97
    ...
    :try_end_34
    .catch Ljava/lang/Exception; {:try_start_2f .. :try_end_34} :catch_a0
    ...
    invoke-interface {v8, v9}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z
    :try_end_6b
    .catch Lmyorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_4a .. :try_end_6b} :catch_b4
