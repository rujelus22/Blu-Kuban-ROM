...
.method constructor <init>(Lmyorg/bouncycastle/asn1/cms/KeyTransRecipientInfo;Lmyorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lmyorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Lmyorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Ljava/io/InputStream;)V
    ...
    :try_end_53
    .catch Ljava/io/IOException; {:try_start_19 .. :try_end_53} :catch_54
...
.method protected getSessionKey(Ljava/security/Key;Ljava/security/Provider;)Ljava/security/Key;
    ...
    :try_end_2b
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_26 .. :try_end_2b} :catch_72
    .catch Ljava/security/InvalidKeyException; {:try_start_26 .. :try_end_2b} :catch_7b
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_26 .. :try_end_2b} :catch_84
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_26 .. :try_end_2b} :catch_8d
    .catch Ljavax/crypto/BadPaddingException; {:try_start_26 .. :try_end_2b} :catch_96
    ...
    :try_end_34
    .catch Ljava/security/GeneralSecurityException; {:try_start_2d .. :try_end_34} :catch_36
    .catch Ljava/lang/IllegalStateException; {:try_start_2d .. :try_end_34} :catch_45
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_2d .. :try_end_34} :catch_54
    .catch Ljava/security/ProviderException; {:try_start_2d .. :try_end_34} :catch_63
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_2d .. :try_end_34} :catch_72
    .catch Ljava/security/InvalidKeyException; {:try_start_2d .. :try_end_34} :catch_7b
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_2d .. :try_end_34} :catch_84
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_2d .. :try_end_34} :catch_8d
    .catch Ljavax/crypto/BadPaddingException; {:try_start_2d .. :try_end_34} :catch_96
    ...
    invoke-direct {v6, v7, v1}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V
    :try_end_71
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_38 .. :try_end_71} :catch_72
    .catch Ljava/security/InvalidKeyException; {:try_start_38 .. :try_end_71} :catch_7b
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_38 .. :try_end_71} :catch_84
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_38 .. :try_end_71} :catch_8d
    .catch Ljavax/crypto/BadPaddingException; {:try_start_38 .. :try_end_71} :catch_96
