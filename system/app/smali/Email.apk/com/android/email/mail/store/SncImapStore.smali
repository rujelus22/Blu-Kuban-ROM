...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    :try_end_2b
    .catch Ljava/net/URISyntaxException; {:try_start_26 .. :try_end_2b} :catch_49
...
.method static decodeFolderName(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_23
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_8 .. :try_end_23} :catch_25
...
.method static encodeFolderName(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_2d
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_8 .. :try_end_2d} :catch_2f
...
.method static getImapId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/android/email/mail/store/imap/ImapResponse;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;
    :try_end_9d
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4b .. :try_end_9d} :catch_bd
    ...
    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;
    :try_end_bc
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_a5 .. :try_end_bc} :catch_bd
...
.method public checkStoreCapability(Ljava/lang/String;)Z
    ...
    .catch Lcom/android/emailcommon/mail/MessagingException; {:try_start_10 .. :try_end_13} :catch_34
...
.method getConnection()Lcom/android/email/mail/store/SncImapStore$ImapConnection;
    ...
    :try_end_1c
    .catchall {:try_start_b .. :try_end_1c} :catchall_4d
    .catch Lcom/android/emailcommon/mail/MessagingException; {:try_start_b .. :try_end_1c} :catch_3f
    .catch Ljava/io/IOException; {:try_start_b .. :try_end_1c} :catch_48
...
.method public getPersonalNamespaces()[Lcom/android/emailcommon/mail/Folder;
    ...
    :try_end_6b
    .catchall {:try_start_4 .. :try_end_6b} :catchall_7c
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_6b} :catch_6c
    .catch Lcom/android/emailcommon/mail/AuthenticationFailedException; {:try_start_4 .. :try_end_6b} :catch_a4
    ...
    :try_end_9b
    .catchall {:try_start_86 .. :try_end_9b} :catchall_7c
    .catch Ljava/io/IOException; {:try_start_86 .. :try_end_9b} :catch_6c
    .catch Lcom/android/emailcommon/mail/AuthenticationFailedException; {:try_start_86 .. :try_end_9b} :catch_a4
    ...
    throw v0
    :try_end_aa
    .catchall {:try_start_a5 .. :try_end_aa} :catchall_7c
.end method
