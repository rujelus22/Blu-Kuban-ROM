...
.method public run()V
    ...
    :try_end_1ab
    .catchall {:try_start_4d .. :try_end_1ab} :catchall_1db
    .catch Ljava/lang/Exception; {:try_start_4d .. :try_end_1ab} :catch_1b9
    ...
    invoke-interface {v10}, Landroid/database/Cursor;->close()V
    :try_end_1b0
    .catch Ljava/lang/Exception; {:try_start_1ad .. :try_end_1b0} :catch_1e3
    ...
    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1d4
    .catchall {:try_start_1ba .. :try_end_1d4} :catchall_1db
    ...
    invoke-interface {v10}, Landroid/database/Cursor;->close()V
    :try_end_1d9
    .catch Ljava/lang/Exception; {:try_start_1d6 .. :try_end_1d9} :catch_1e5
    ...
    invoke-interface {v10}, Landroid/database/Cursor;->close()V
    :try_end_1e1
    .catch Ljava/lang/Exception; {:try_start_1de .. :try_end_1e1} :catch_1e7
