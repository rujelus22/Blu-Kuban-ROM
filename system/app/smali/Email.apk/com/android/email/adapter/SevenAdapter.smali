...
.method public static initSevenState(Landroid/content/Context;Z)V
    ...
    :try_end_17
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_8 .. :try_end_17} :catch_32
...
.method public deleteAccountSync(JLandroid/content/Context;)V
    ...
    :try_end_7d
    .catch Ljava/lang/Exception; {:try_start_34 .. :try_end_7d} :catch_7e
...
.method public deleteMessageSync([JJ)V
    ...
    :try_end_5b
    .catch Ljava/lang/Exception; {:try_start_31 .. :try_end_5b} :catch_256
    ...
    :try_end_66
    .catchall {:try_start_5c .. :try_end_66} :catchall_bd
    ...
    invoke-interface {v10, v2}, Landroid/database/Cursor;->getInt(I)I
    :try_end_6b
    .catchall {:try_start_68 .. :try_end_6b} :catchall_25b
    ...
    throw v2
    :try_end_c4
    .catch Ljava/lang/Exception; {:try_start_6c .. :try_end_c4} :catch_c4
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_193
    .catch Ljava/lang/Exception; {:try_start_e1 .. :try_end_193} :catch_c4
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_200
    .catchall {:try_start_197 .. :try_end_200} :catchall_245
    .catch Ljava/lang/Exception; {:try_start_197 .. :try_end_200} :catch_219
    ...
    invoke-virtual {v2, v0, v11, v3, v4}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_20f
    .catch Ljava/lang/Exception; {:try_start_202 .. :try_end_20f} :catch_c4
    ...
    :try_end_218
    .catchall {:try_start_211 .. :try_end_218} :catchall_245
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_234
    .catchall {:try_start_21c .. :try_end_234} :catchall_245
    ...
    throw v2
    :try_end_256
    .catch Ljava/lang/Exception; {:try_start_236 .. :try_end_256} :catch_c4
...
.method public moveMessageToSameAccount(Ljava/util/ArrayList;[JLcom/android/emailcommon/provider/EmailContent$Account;JJJZ)V
    ...
    invoke-interface {v10, v3}, Landroid/database/Cursor;->getInt(I)I
    :try_end_9d
    .catchall {:try_start_8e .. :try_end_9d} :catchall_1ca
    ...
    invoke-interface {v10, v3}, Landroid/database/Cursor;->getInt(I)I
    :try_end_c7
    .catchall {:try_start_b8 .. :try_end_c7} :catchall_1cf
    ...
    :try_end_100
    .catchall {:try_start_f6 .. :try_end_100} :catchall_1d4
    ...
    :try_end_17d
    .catchall {:try_start_106 .. :try_end_17d} :catchall_249
    .catch Ljava/lang/Exception; {:try_start_106 .. :try_end_17d} :catch_1e1
    ...
    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1e0
    .catchall {:try_start_1d9 .. :try_end_1e0} :catchall_249
    .catch Ljava/lang/Exception; {:try_start_1d9 .. :try_end_1e0} :catch_1e1
    ...
    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_1fc
    .catchall {:try_start_1e4 .. :try_end_1fc} :catchall_249
...
.method public sendMessage(JJJ)V
    ...
    iget v6, v4, Lcom/android/emailcommon/provider/EmailContent$Message;->mFlags:I
    :try_end_58
    .catch Landroid/os/RemoteException; {:try_start_2c .. :try_end_58} :catch_98
    .catch Ljava/lang/Exception; {:try_start_2c .. :try_end_58} :catch_b2
    ...
    :try_end_68
    .catch Ljava/lang/Exception; {:try_start_5c .. :try_end_68} :catch_7e
    ...
    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_97
    .catch Landroid/os/RemoteException; {:try_start_68 .. :try_end_97} :catch_98
    .catch Ljava/lang/Exception; {:try_start_68 .. :try_end_97} :catch_b2
...
.method public sendPendingMessages(J)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_43
    .catch Ljava/lang/Exception; {:try_start_1f .. :try_end_43} :catch_53
    ...
    :try_end_4f
    .catchall {:try_start_44 .. :try_end_4f} :catchall_9e
    .catch Ljava/lang/Exception; {:try_start_44 .. :try_end_4f} :catch_8a
    ...
    :try_end_89
    .catch Ljava/lang/Exception; {:try_start_7c .. :try_end_89} :catch_53
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/android/email/Controller$Result;->sendMailCallback(Lcom/android/emailcommon/mail/MessagingException;JJI)V
    :try_end_9a
    .catchall {:try_start_8b .. :try_end_9a} :catchall_9e
    ...
    throw v1
    :try_end_a3
    .catch Ljava/lang/Exception; {:try_start_9a .. :try_end_a3} :catch_53
...
.method public serviceCheckMail(JJJLcom/android/email/Controller$Result;)V
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/android/email/Controller$Result;->serviceCheckMailCallback(Lcom/android/emailcommon/mail/MessagingException;JJIJ)V
    :try_end_122
    .catch Ljava/lang/Exception; {:try_start_f .. :try_end_122} :catch_123
    ...
    :try_end_15d
    .catch Ljava/lang/Exception; {:try_start_151 .. :try_end_15d} :catch_123
...
.method public setMessageBoolean([JLjava/lang/String;ZJ)V
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_68
    .catch Ljava/lang/Exception; {:try_start_4a .. :try_end_68} :catch_fc
    ...
    invoke-interface {v10, v2}, Landroid/database/Cursor;->getInt(I)I
    :try_end_73
    .catchall {:try_start_69 .. :try_end_73} :catchall_f7
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_d7
    .catch Ljava/lang/Exception; {:try_start_74 .. :try_end_d7} :catch_d9
    ...
    throw v2
    :try_end_fc
    .catch Ljava/lang/Exception; {:try_start_f8 .. :try_end_fc} :catch_fc
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_16d
    .catch Ljava/lang/Exception; {:try_start_100 .. :try_end_16d} :catch_d9
...
.method public setMessageRead(JZ)V
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    :try_end_47
    .catch Ljava/lang/Exception; {:try_start_2b .. :try_end_47} :catch_b2
    ...
    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_aa
    .catch Ljava/lang/Exception; {:try_start_53 .. :try_end_aa} :catch_cd
    ...
    throw v2
    :try_end_b2
    .catch Ljava/lang/Exception; {:try_start_ae .. :try_end_b2} :catch_b2
...
.method public updateMailbox(JJZ)V
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/android/email/Controller$Result;->updateMailboxCallback(Lcom/android/emailcommon/mail/MessagingException;JJII)V
    :try_end_13a
    .catch Ljava/lang/Exception; {:try_start_34 .. :try_end_13a} :catch_13b
