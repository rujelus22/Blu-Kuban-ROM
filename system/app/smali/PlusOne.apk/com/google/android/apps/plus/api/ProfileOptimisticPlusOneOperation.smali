...
# virtual methods
.method public createProfilePlusOne(J)V
    .registers 9
    .parameter "gaiaId"

    .prologue
    .line 48
    iput-wide p1, p0, Lcom/google/android/apps/plus/api/ProfileOptimisticPlusOneOperation;->mGaiaId:J
    ...
    iget-wide v3, p0, Lcom/google/android/apps/plus/api/ProfileOptimisticPlusOneOperation;->mGaiaId:J

    const/4 v5, 0x1

    invoke-static {v1, v2, v3, v4, v5}, Lcom/google/android/apps/plus/content/EsPeopleData;->changePlusOneData(Landroid/content/Context;Lcom/google/android/apps/plus/content/EsAccount;JZ)Z
...
.method public deleteProfilePlusOne(JLjava/lang/String;)V
    .registers 10
    .parameter "gaiaId"
    .parameter "plusOneId"
...
.method protected onHttpOperationComplete(ILjava/lang/String;Ljava/lang/Exception;)V
    ...
    iget-wide v2, p0, Lcom/google/android/apps/plus/api/ProfileOptimisticPlusOneOperation;->mGaiaId:J

    const/4 v4, 0x0

    invoke-static {v0, v1, v2, v3, v4}, Lcom/google/android/apps/plus/content/EsPeopleData;->changePlusOneData(Landroid/content/Context;Lcom/google/android/apps/plus/content/EsAccount;JZ)Z
