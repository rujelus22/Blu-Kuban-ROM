.class Lcom/google/android/apps/plus/service/EsService$14;
...
.method constructor <init>(Lcom/google/android/apps/plus/service/EsService;Landroid/content/Context;Lcom/google/android/apps/plus/content/EsAccount;Landroid/content/Intent;)V
    ...
    .prologue
    .line 3379
    iput-object p1, p0, Lcom/google/android/apps/plus/service/EsService$14;->this$0:Lcom/google/android/apps/plus/service/EsService;

    iput-object p2, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$context:Landroid/content/Context;

    iput-object p3, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$account:Lcom/google/android/apps/plus/content/EsAccount;

    iput-object p4, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$intent:Landroid/content/Intent;
...
.method public run()V
    ...
    .line 3387
    :try_start_1
    iget-object v1, p0, Lcom/google/android/apps/plus/service/EsService$14;->this$0:Lcom/google/android/apps/plus/service/EsService;

    iget-object v2, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$context:Landroid/content/Context;

    iget-object v3, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$account:Lcom/google/android/apps/plus/content/EsAccount;

    iget-object v4, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$intent:Landroid/content/Intent;

    invoke-virtual {v1, v2, v3, v4}, Lcom/google/android/apps/plus/service/EsService;->doSetPersonBlocked(Landroid/content/Context;Lcom/google/android/apps/plus/content/EsAccount;Landroid/content/Intent;)V

    .line 3388
    iget-object v1, p0, Lcom/google/android/apps/plus/service/EsService$14;->this$0:Lcom/google/android/apps/plus/service/EsService;

    iget-object v2, p0, Lcom/google/android/apps/plus/service/EsService$14;->val$intent:Landroid/content/Intent;
