.class public Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils;
.super Ljava/lang/Object;
.source "HangoutRingtoneUtils.java"
...
.method static synthetic access$000(Landroid/content/Context;)Z
    ...
    .prologue
    .line 26
    invoke-static {p0}, Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils;->hasRingtone(Landroid/content/Context;)Z
...
.method static synthetic access$100(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .prologue
    .line 26
    invoke-static {p0, p1}, Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils;->setRingtone(Landroid/content/Context;Landroid/net/Uri;)V

    return-void
.end method

.method private static copyResourceToFile(Landroid/content/Context;)Ljava/io/File;
    .registers 11
    .parameter "context"
    ...
    const-string v7, "hangout_ringtone.m4a"
...
.method public static getRingtone(Landroid/content/Context;)Landroid/net/Uri;
    ...
    const-string v5, "Hangout ringtone; uri: "
    ...
    const-string v5, "Hangout ringtone not set"
...
.method public static registerHangoutRingTone(Landroid/content/Context;)V
    .registers 5
    .parameter "context"

    .prologue
    .line 41
    invoke-static {p0}, Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils;->copyResourceToFile(Landroid/content/Context;)Ljava/io/File;
    ...
    new-instance v3, Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils$1;

    invoke-direct {v3, p0}, Lcom/google/android/apps/plus/phone/HangoutRingtoneUtils$1;-><init>(Landroid/content/Context;)V
...
.method private static setRingtone(Landroid/content/Context;Landroid/net/Uri;)V
    .registers 8
    .parameter "context"
    .parameter "uri"
    ...
    const-string v5, "Hangout ringtone set; uri: "
