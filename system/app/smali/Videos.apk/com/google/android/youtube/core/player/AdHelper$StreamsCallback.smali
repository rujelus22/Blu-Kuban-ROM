...
.method public onResponse(Lcom/google/android/youtube/core/async/GDataRequest;Lcom/google/android/youtube/core/model/VideoStreams;)V
    ...
    iget-object v2, p0, Lcom/google/android/youtube/core/player/AdHelper$StreamsCallback;->originalVideoId:Ljava/lang/String;

    iget-object v0, p0, Lcom/google/android/youtube/core/player/AdHelper$StreamsCallback;->originalVastAd:Lcom/google/android/youtube/core/model/VastAd;

    invoke-virtual {v0}, Lcom/google/android/youtube/core/model/VastAd;->buildUpon()Lcom/google/android/youtube/core/model/VastAd$Builder;

    move-result-object v3

    iget-object v0, p0, Lcom/google/android/youtube/core/player/AdHelper$StreamsCallback;->this$0:Lcom/google/android/youtube/core/player/AdHelper;

    #getter for: Lcom/google/android/youtube/core/player/AdHelper;->preferHQ:Z
    invoke-static {v0}, Lcom/google/android/youtube/core/player/AdHelper;->access$400(Lcom/google/android/youtube/core/player/AdHelper;)Z

    move-result v0

    if-eqz v0, :cond_26

    iget-object v0, p2, Lcom/google/android/youtube/core/model/VideoStreams;->hi:Lcom/google/android/youtube/core/model/Stream;

    iget-object v0, v0, Lcom/google/android/youtube/core/model/Stream;->uri:Landroid/net/Uri;

    :goto_1a
    invoke-virtual {v3, v0}, Lcom/google/android/youtube/core/model/VastAd$Builder;->streamUri(Landroid/net/Uri;)Lcom/google/android/youtube/core/model/VastAd$Builder;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/youtube/core/model/VastAd$Builder;->build()Lcom/google/android/youtube/core/model/VastAd;
    ...
    .line 182
    :cond_26
    iget-object v0, p2, Lcom/google/android/youtube/core/model/VideoStreams;->lo:Lcom/google/android/youtube/core/model/Stream;
