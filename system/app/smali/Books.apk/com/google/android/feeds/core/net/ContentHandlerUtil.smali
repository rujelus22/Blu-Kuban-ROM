...
.method public static getResponseCode(Ljava/net/URLConnection;)I
    ...
    :try_start_a
    sget-object v5, Lcom/google/android/feeds/core/net/ContentHandlerUtil;->sContentAuthenticator:Lcom/google/android/feeds/core/net/ContentAuthenticator;
    ...
    invoke-virtual {v5, v6}, Lcom/google/android/feeds/core/net/ContentAuthenticator;->setEnabled(Z)V

    .line 196
    invoke-virtual {v1}, Ljava/net/HttpURLConnection;->getResponseCode()I
    :try_end_18
    .catchall {:try_start_a .. :try_end_18} :catchall_47
    .catch Lcom/google/android/feeds/core/net/ContentAuthenticator$UnauthorizedException; {:try_start_a .. :try_end_18} :catch_3e
    ...
    invoke-virtual {v5, v7}, Lcom/google/android/feeds/core/net/ContentAuthenticator;->setEnabled(Z)V
    ...
    :try_end_3b
    .catch Ljava/lang/NumberFormatException; {:try_start_38 .. :try_end_3b} :catch_4e
    ...
    .line 198
    .local v0, e:Lcom/google/android/feeds/core/net/ContentAuthenticator$UnauthorizedException;
    const/16 v5, 0x191
    ...
    .end local v0           #e:Lcom/google/android/feeds/core/net/ContentAuthenticator$UnauthorizedException;
    :catchall_47
    move-exception v5
...
.method public static getUncompressedInputStream(Ljava/net/URLConnection;)Ljava/io/InputStream;
    ...
    .line 166
    .end local v3           #source:Ljava/io/InputStream;
    :cond_20
    :goto_20
    return-object v3

    .line 161
    .restart local v3       #source:Ljava/io/InputStream;
    :cond_21
...
.method public static openConnection(Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    .line 77
    invoke-virtual {v1, v4}, Ljava/net/HttpURLConnection;->setAllowUserInteraction(Z)V
