...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/google/android/apps/books/service/SyncAdapter;->enqueueSection(Ljava/lang/String;Ljava/lang/String;Landroid/accounts/Account;ILcom/google/android/apps/books/service/SyncAdapter$SyncContext;Landroid/content/SyncResult;)V
.end annotation
...
.method constructor <init>(Lcom/google/android/apps/books/service/SyncAdapter;Lcom/google/android/apps/books/service/SyncAdapter$SyncContext;Landroid/content/SyncResult;Ljava/lang/String;Ljava/lang/String;Landroid/accounts/Account;ILcom/google/android/apps/books/service/SyncAdapter$SyncContext;Landroid/content/SyncResult;)V
    ...
    iput-object p4, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$volumeId:Ljava/lang/String;

    iput-object p5, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$sectionId:Ljava/lang/String;

    iput-object p6, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$account:Landroid/accounts/Account;

    iput p7, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$priority:I

    iput-object p8, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$syncContext:Lcom/google/android/apps/books/service/SyncAdapter$SyncContext;

    iput-object p9, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$syncResult:Landroid/content/SyncResult;
...
.method public ensureLocked()V
    ...
    iget-object v5, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$syncContext:Lcom/google/android/apps/books/service/SyncAdapter$SyncContext;

    iget-object v6, p0, Lcom/google/android/apps/books/service/SyncAdapter$3;->val$syncResult:Landroid/content/SyncResult;

    #calls: Lcom/google/android/apps/books/service/SyncAdapter;->enqueueSegmentResources(Ljava/lang/String;Ljava/lang/String;Landroid/accounts/Account;ILcom/google/android/apps/books/service/SyncAdapter$SyncContext;Landroid/content/SyncResult;)V
    invoke-static/range {v0 .. v6}, Lcom/google/android/apps/books/service/SyncAdapter;->access$400(Lcom/google/android/apps/books/service/SyncAdapter;Ljava/lang/String;Ljava/lang/String;Landroid/accounts/Account;ILcom/google/android/apps/books/service/SyncAdapter$SyncContext;Landroid/content/SyncResult;)V
