...
.method static toGetSignUpState(Lcom/google/android/apps/pos/network/BatchResponseItemJson;)Lcom/google/android/apps/pos/model/SignUpState;
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;->getProfileImageUrl()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/google/android/apps/pos/model/SignUpState;->setProfileImageUrl(Ljava/lang/String;)Lcom/google/android/apps/pos/model/SignUpState;
...
.method static toPlusone(Lcom/google/android/apps/pos/network/BatchResponseItemJson;)Lcom/google/android/apps/pos/model/Plusone;
    ...
    .line 76
    invoke-virtual {v1}, Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;->getAbuseToken()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/apps/pos/model/Plusone;->setAbuseToken(Ljava/lang/String;)Lcom/google/android/apps/pos/model/Plusone;
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/apps/pos/model/Plusone;->setId(Ljava/lang/String;)Lcom/google/android/apps/pos/model/Plusone;
...
.method static toPlusones(Lcom/google/android/apps/pos/network/BatchResponseItemJson;)Lcom/google/android/apps/pos/model/Plusones;
    .registers 4
    .parameter "responseJson"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 39
    .local v0, plusones:Lcom/google/android/apps/pos/model/Plusones;
    invoke-virtual {p0}, Lcom/google/android/apps/pos/network/BatchResponseItemJson;->getResponseId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/apps/pos/model/Plusones;->setResponseId(Ljava/lang/String;)Lcom/google/android/apps/pos/model/Plusones;
    ...
    .line 48
    .end local v0           #plusones:Lcom/google/android/apps/pos/model/Plusones;
    :goto_1f
    return-object v0

    .line 46
    .restart local v0       #plusones:Lcom/google/android/apps/pos/model/Plusones;
    :cond_20
    invoke-virtual {p0}, Lcom/google/android/apps/pos/network/BatchResponseItemJson;->getResult()Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;
    ...
    .line 47
    .local v1, resultJson:Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;
    invoke-virtual {v1}, Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;->getContinuationToken()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/apps/pos/model/Plusones;->setContinuationToken(Ljava/lang/String;)Lcom/google/android/apps/pos/model/Plusones;

    .line 48
    invoke-virtual {v1}, Lcom/google/android/apps/pos/network/BatchResponseItemJson$ResultJson;->getItems()[Lcom/google/android/apps/pos/model/Plusone;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/apps/pos/model/Plusones;->setItems([Lcom/google/android/apps/pos/model/Plusone;)Lcom/google/android/apps/pos/model/Plusones;
