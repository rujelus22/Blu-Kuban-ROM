...
.method protected testSerialize(Ljava/lang/String;)V
    ...
    .line 109
    const-string v9, "Read back document after serialization"

    if-eqz v2, :cond_51

    .line 110
    instance-of v8, v2, Lorg/dom4j/Document;
    ...
    .line 109
    :goto_41
    invoke-static {v9, v8}, Lorg/dom4j/SerializeTest;->assertTrue(Ljava/lang/String;Z)V
...
.method public testSerializeXPath()V
    ...
    const-string v13, "Found valid element"
    ...
    :goto_34
    invoke-static {v13, v12}, Lorg/dom4j/SerializeTest;->assertTrue(Ljava/lang/String;Z)V
