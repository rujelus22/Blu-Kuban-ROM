...
.method public testTransform()V
    ...
    const-string v6, "Transformed Document is not null"
    ...
    :goto_d
    invoke-static {v6, v3}, Lorg/dom4j/XSLTTest;->assertTrue(Ljava/lang/String;Z)V
    ...
    const-string v6, "At least one <h1>"
...
.method protected transform(Ljava/lang/String;)Lorg/dom4j/Document;
    ...
    .prologue
    .line 58
    const-string v5, "Document is not null"
    ...
    :goto_7
    invoke-static {v5, v4}, Lorg/dom4j/XSLTTest;->assertTrue(Ljava/lang/String;Z)V
