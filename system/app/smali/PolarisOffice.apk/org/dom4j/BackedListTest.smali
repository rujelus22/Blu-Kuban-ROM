...
.method protected mutate(Lorg/dom4j/Element;)V
    ...
    invoke-virtual {v0, v5}, Lorg/dom4j/DocumentFactory;->createElement(Ljava/lang/String;)Lorg/dom4j/Element;
    ...
    const-string v5, "Both lists should contain same number of elements"
    ...
    :cond_2c
    invoke-static {v5, v4}, Lorg/dom4j/BackedListTest;->assertTrue(Ljava/lang/String;Z)V
...
.method public testAddRemove()V
    ...
    :try_end_21
    .catch Lorg/dom4j/IllegalAddException; {:try_start_1b .. :try_end_21} :catch_22
...
.method public testAddWithIndex()V
    ...
    invoke-static {v4, v3}, Lorg/dom4j/BackedListTest;->assertEquals(Ljava/lang/String;Ljava/lang/String;)V

    .line 74
    const-string v4, "dummy2"
