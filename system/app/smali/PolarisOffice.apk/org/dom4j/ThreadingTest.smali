...
.method public testCombo()V
    ...
    invoke-static {v0, v11, v1}, Lorg/dom4j/ThreadingTest;->assertEquals(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v15, v0}, Lorg/dom4j/Element;->setText(Ljava/lang/String;)V
    ...
    invoke-interface {v13, v0}, Lorg/dom4j/Element;->setQName(Lorg/dom4j/QName;)V

    .line 131
    move-object/from16 v0, v20

    invoke-interface {v0, v13}, Lorg/dom4j/Element;->add(Lorg/dom4j/Element;)V
    ...
    invoke-interface {v13, v0}, Lorg/dom4j/Element;->getQName(Ljava/lang/String;)Lorg/dom4j/QName;
    ...
    invoke-static {v0, v11, v1}, Lorg/dom4j/ThreadingTest;->assertEquals(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_18a
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_18a} :catch_18e
...
.method public testQNameCache()V
    ...
    .line 186
    .local v19, root:Lorg/dom4j/Element;
    const/4 v12, 0x0

    .line 187
    .local v12, item:Lorg/dom4j/Element;
    const/4 v14, 0x0

    .line 188
    .local v14, newItem:Lorg/dom4j/Element;
    const/16 v18, 0x0

    .line 189
    .local v18, qn:Lorg/dom4j/QName;
    const/16 v17, 0x0

    .line 190
    .local v17, ns:Lorg/dom4j/Namespace;
    const-wide/16 v15, 0x0

    .line 192
    .local v15, now:J
    const-string v21, "<ROOT xmlns:t0=\"http://www.lse.com/t0\" >  <ctx><type>Context</type></ctx>  <A><B><C><D>This is a TEST</D></C></B></A>  <t0:Signon><A>xyz</A><t0:Cust>customer</t0:Cust></t0:Signon></ROOT>"
    ...
    div-double v2, v7, v22

    .line 225
    .end local v4           #begin:J
    .end local v6           #doc:Lorg/dom4j/Document;
    .end local v7           #duration:D
    .end local v10           #expected:Ljava/lang/String;
    .end local v11           #i:I
    .end local v12           #item:Lorg/dom4j/Element;
    .end local v14           #newItem:Lorg/dom4j/Element;
    .end local v15           #now:J
    .end local v17           #ns:Lorg/dom4j/Namespace;
    .end local v18           #qn:Lorg/dom4j/QName;
    .end local v19           #root:Lorg/dom4j/Element;
    ...
    .restart local v10       #expected:Ljava/lang/String;
    .restart local v11       #i:I
    .restart local v12       #item:Lorg/dom4j/Element;
    .restart local v14       #newItem:Lorg/dom4j/Element;
    .restart local v15       #now:J
    .restart local v17       #ns:Lorg/dom4j/Namespace;
    .restart local v18       #qn:Lorg/dom4j/QName;
    .restart local v19       #root:Lorg/dom4j/Element;
    ...
    invoke-static/range {v22 .. v22}, Lorg/dom4j/DocumentHelper;->createQName(Ljava/lang/String;)Lorg/dom4j/QName;
    ...
    .line 205
    const-string v22, "test test "

    move-object/from16 v0, v22

    move-object/from16 v1, v20

    invoke-static {v0, v10, v1}, Lorg/dom4j/ThreadingTest;->assertEquals(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 211
    const-string v22, "test test again "
    ...
    .line 215
    const-string v10, "<t0:Signon xmlns:t0=\"http://www.lse.com/t0\"/>"

    .line 216
    const-string v22, "test t0:Signon "
    ...
    const-string v23, "Exception in test: "
    ...
    invoke-static/range {v22 .. v23}, Lorg/dom4j/ThreadingTest;->assertTrue(Ljava/lang/String;Z)V
