...
.method public getTicket(Lcn/com/believer/songyuanframework/openapi/storage/box/functions/GetTicketRequest;)Lcn/com/believer/songyuanframework/openapi/storage/box/functions/GetTicketResponse;
    ...
    invoke-interface {v12, v0}, Lorg/dom4j/Element;->element(Ljava/lang/String;)Lorg/dom4j/Element;
    ...
    invoke-interface {v10, v0}, Lcn/com/believer/songyuanframework/openapi/storage/box/functions/GetTicketResponse;->setTicket(Ljava/lang/String;)V
    :try_end_70
    .catch Lorg/dom4j/DocumentException; {:try_start_34 .. :try_end_70} :catch_71
    ...
    invoke-direct {v0, v1, v9}, Lcn/com/believer/songyuanframework/openapi/storage/box/objects/BoxException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, v0}, Lorg/dom4j/Element;->setText(Ljava/lang/String;)V
    ...
    invoke-interface {v10, v0}, Lcn/com/believer/songyuanframework/openapi/storage/box/functions/GetTicketResponse;->setTicket(Ljava/lang/String;)V
    :try_end_fb
    .catch Lorg/dom4j/DocumentException; {:try_start_c9 .. :try_end_fb} :catch_fd
    ...
    invoke-interface {v7, v0}, Lorg/dom4j/Document;->elementByID(Ljava/lang/String;)Lorg/dom4j/Element;
    ...
    invoke-interface {v10, v0}, Lcn/com/believer/songyuanframework/openapi/storage/box/functions/GetTicketResponse;->setTicket(Ljava/lang/String;)V
    :try_end_191
    .catch Lorg/dom4j/DocumentException; {:try_start_15b .. :try_end_191} :catch_193
