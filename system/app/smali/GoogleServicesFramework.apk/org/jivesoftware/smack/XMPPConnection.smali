...
.method private closeSocket()V
    ...
    :try_end_12
    .catchall {:try_start_6 .. :try_end_12} :catchall_31
...
.method private connectUsingConfiguration(Lorg/jivesoftware/smack/ConnectionConfiguration;Ljavax/net/SocketFactory;)V
    ...
    :try_end_45
    .catch Ljava/net/UnknownHostException; {:try_start_c .. :try_end_45} :catch_92
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_45} :catch_c7
    ...
    :try_end_59
    .catch Ljava/lang/CloneNotSupportedException; {:try_start_51 .. :try_end_59} :catch_124
    ...
    invoke-direct {p0, v3, v4}, Lorg/jivesoftware/smack/XMPPConnection;->logd(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_86
    .catch Lorg/jivesoftware/smack/XMPPException; {:try_start_59 .. :try_end_86} :catch_fc
    ...
    iput-object v3, p0, Lorg/jivesoftware/smack/XMPPConnection;->socket:Ljava/net/Socket;
    :try_end_91
    .catch Ljava/net/UnknownHostException; {:try_start_87 .. :try_end_91} :catch_92
    .catch Ljava/io/IOException; {:try_start_87 .. :try_end_91} :catch_c7
...
.method private initReaderAndWriter()V
    ...
    :try_end_35
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_35} :catch_70
    ...
    :try_end_47
    .catch Ljava/lang/Throwable; {:try_start_35 .. :try_end_47} :catch_80
    .catch Ljava/io/IOException; {:try_start_35 .. :try_end_47} :catch_70
    ...
    :try_end_6f
    .catch Ljava/io/IOException; {:try_start_47 .. :try_end_6f} :catch_70
    ...
    :try_end_88
    .catch Ljava/io/IOException; {:try_start_81 .. :try_end_88} :catch_70
...
.method private useCompression()Z
    ...
    .catch Ljava/lang/InterruptedException; {:try_start_20 .. :try_end_2a} :catch_31
    ...
    monitor-exit p0
    :try_end_2b
    .catchall {:try_start_2a .. :try_end_2b} :catchall_2e
...
.method public declared-synchronized bindAccount(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Ljava/lang/String;
    ...
    :try_end_75
    .catchall {:try_start_40 .. :try_end_75} :catchall_3d
...
.method public close(Z)V
    ...
    monitor-exit v1
    :try_end_58
    .catchall {:try_start_4c .. :try_end_58} :catchall_22
...
.method public connect()V
    ...
    throw v1
    :try_end_13
    .catch Lorg/jivesoftware/smack/XMPPException; {:try_start_0 .. :try_end_13} :catch_13
    ...
    :try_end_26
    .catch Lorg/jivesoftware/smack/XMPPException; {:try_start_19 .. :try_end_26} :catch_13
...
.method public declared-synchronized login(ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJZLjava/util/List;ZJIZLorg/jivesoftware/smack/packet/HeartbeatStat;Ljava/util/Map;)V
    ...
    invoke-direct {v0, v4, v5}, Lorg/jivesoftware/smack/XMPPConnection;->logd(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1a2
    .catchall {:try_start_dd .. :try_end_1a2} :catchall_f
