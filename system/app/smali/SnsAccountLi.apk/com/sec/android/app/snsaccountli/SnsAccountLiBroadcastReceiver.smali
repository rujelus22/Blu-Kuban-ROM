.class public Lcom/sec/android/app/snsaccountli/SnsAccountLiBroadcastReceiver;
.super Landroid/content/BroadcastReceiver;
.source "SnsAccountLiBroadcastReceiver.java"
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v12, "com.sec.android.app.sns.action.RETRY_LOGIN_LINKEDIN"
    ...
    const-string v12, "com.sec.android.app.sns.action.RETRY_LOGIN_LINKEDIN_BY_APPS"
    ...
    .line 52
    :cond_14
    const-string v12, "SnsAccountLi"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "SnsAccountLiBroadcastReceiver : onReceive() : received~ :action = "
    ...
    const-string v13, "SnsAccountLiBroadcastReceiver : RETRY_LOGIN_NOTIFICATION : spType = 8"
    ...
    const-string v12, "com.sec.android.app.snsaccountli.RETRY_LOGIN_LINKEDIN"

    invoke-direct {v9, v12}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V
    :try_end_48
    .catch Ljava/lang/Exception; {:try_start_41 .. :try_end_48} :catch_97
    ...
    const-string v12, "com.sec.android.app.snsaccountlinkedin.account_type"
    ...
    :try_end_96
    .catch Ljava/lang/Exception; {:try_start_4a .. :try_end_96} :catch_d2
    ...
    const-string v14, "SnsAccountLiBroadcastReceiver : DEBUG - "
    ...
    invoke-static {v12}, Lcom/sec/android/app/snsaccountli/util/SnsAccountLiUtil;->setDebugMode(Z)V
