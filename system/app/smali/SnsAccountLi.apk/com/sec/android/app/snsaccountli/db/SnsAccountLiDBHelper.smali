.class public Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;
.super Landroid/database/sqlite/SQLiteOpenHelper;
.source "SnsAccountLiDBHelper.java"


# static fields
.field private static mInstance:Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInstance:Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 73
    const-string v0, "snsAccountLiDB.db"
    ...
    iput-object v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->SNS_DB_PRIMARY_KEY_TYPE:Ljava/lang/String;

    .line 49
    const-string v0, "INTEGER"

    iput-object v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->SNS_DB_INTEGER_TYPE:Ljava/lang/String;

    .line 51
    const-string v0, "VARCHAR(10)"

    iput-object v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->SNS_DB_SYNC_TYPE:Ljava/lang/String;

    .line 53
    const-string v0, "VARCHAR(40)"

    iput-object v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->SNS_DB_USERNAME_TYPE:Ljava/lang/String;

    .line 55
    const-string v0, "TIMESTAMP"

    iput-object v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->SNS_DB_TIME_TYPE:Ljava/lang/String;

    .line 57
    const/4 v0, 0x0

    iput v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInitPollingCycle:I

    .line 59
    const/4 v0, -0x1

    iput v0, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInitPreviousRequestId:I

    .line 75
    iput-object p1, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mContext:Landroid/content/Context;

    .line 76
    return-void
.end method

.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;
    .registers 3
    .parameter "context"

    .prologue
    .line 66
    const-class v1, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;

    monitor-enter v1

    :try_start_3
    sget-object v0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInstance:Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;

    if-nez v0, :cond_e

    .line 67
    new-instance v0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;

    invoke-direct {v0, p0}, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;-><init>(Landroid/content/Context;)V
...
.method public createTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget v1, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInitPollingCycle:I
    ...
    iget v1, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mInitPreviousRequestId:I
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 80
    invoke-virtual {p0, p1}, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->createTables(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 98
    iget-object v3, p0, Lcom/sec/android/app/snsaccountli/db/SnsAccountLiDBHelper;->mContext:Landroid/content/Context;
    ...
    const-string v4, "onUpgrade : removePeriodicSync spType :8"
