...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/place/connector/IBrokerService$Stub;
.end annotation
...
.method public addPreferredPlace(Landroid/support/place/connector/PlaceInfo;)V
    ...
    :try_start_8
    const-string v2, "android.support.place.connector.IBrokerService"
    ...
    invoke-virtual {p1, v0, v2}, Landroid/support/place/connector/PlaceInfo;->writeToParcel(Landroid/os/Parcel;I)V

    .line 566
    :goto_17
    iget-object v2, p0, Landroid/support/place/connector/IBrokerService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public doSyncNow(Ljava/lang/String;)J
    ...
    .local v1, _reply:Landroid/os/Parcel;
    :try_start_8
    const-string v4, "android.support.place.connector.IBrokerService"
    ...
    .line 755
    iget-object v4, p0, Landroid/support/place/connector/IBrokerService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getPreferredPlaces()Ljava/util/List;
    ...
    .line 533
    .local v2, _result:Ljava/util/List;,"Ljava/util/List<Landroid/support/place/connector/PlaceInfo;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 533
    .end local v2           #_result:Ljava/util/List;,"Ljava/util/List<Landroid/support/place/connector/PlaceInfo;>;"
    :catchall_25
    move-exception v3
...
.method public getUserData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/support/place/rpc/RpcData;
    ...
    check-cast v2, Landroid/support/place/rpc/RpcData;
    :try_end_32
    ...
    .restart local v2       #_result:Landroid/support/place/rpc/RpcData;
    goto :goto_32
...
.method public registerConnector(Landroid/support/place/rpc/IEndpointStub;Landroid/support/place/connector/ConnectorInfo;)V
    ...
    invoke-virtual {p2, v0, v2}, Landroid/support/place/connector/ConnectorInfo;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public registerEndpoint(Landroid/support/place/rpc/IEndpointStub;Landroid/support/place/rpc/EndpointInfo;)V
    ...
    invoke-virtual {p2, v0, v2}, Landroid/support/place/rpc/EndpointInfo;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public saveUserData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/support/place/rpc/RpcData;)V
    ...
    invoke-virtual {p5, v0, v2}, Landroid/support/place/rpc/RpcData;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public sendRequest(Ljava/lang/String;Landroid/support/place/rpc/EndpointInfo;[BLandroid/support/place/rpc/IRpcCallback;Landroid/support/place/connector/IBrokerConnection;I)V
    ...
    invoke-virtual {p2, v0, v3}, Landroid/support/place/rpc/EndpointInfo;->writeToParcel(Landroid/os/Parcel;I)V
