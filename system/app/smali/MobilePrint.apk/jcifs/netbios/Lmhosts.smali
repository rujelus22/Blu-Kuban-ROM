...
.method static declared-synchronized getByName(Ljcifs/netbios/Name;)Ljcifs/netbios/NbtAddress;
    ...
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_35} :catch_5c
    ...
    :try_end_58
    .catchall {:try_start_38 .. :try_end_58} :catchall_59
    ...
    :try_end_66
    .catchall {:try_start_5d .. :try_end_66} :catchall_59
...
.method static populate(Ljava/io/Reader;)V
    ...
    :try_end_6b
    .catch Ljava/io/IOException; {:try_start_5c .. :try_end_6b} :catch_8b
    ...
    if-ge v0, v6, :cond_164

    aget-char v15, v16, v17

    const/16 v6, 0x30

    if-lt v15, v6, :cond_164

    const/16 v6, 0x39

    if-le v15, v6, :cond_16b
