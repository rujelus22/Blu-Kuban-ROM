...
.method static declared-synchronized getSmbTransport(Ljcifs/UniAddress;ILjava/net/InetAddress;ILjava/lang/String;)Ljcifs/smb/SmbTransport;
    ...
    monitor-exit v9
    :try_end_23
    .catchall {:try_start_6 .. :try_end_23} :catchall_48
...
.method private negotiate(ILjcifs/smb/ServerMessageBlock;)V
    ...
    iput v4, v2, Ljcifs/smb/ServerMessageBlock;->mid:I
    ...
    monitor-exit v3
    :try_end_fa
    .catchall {:try_start_6e .. :try_end_fa} :catchall_67
...
.method protected doRecv(Ljcifs/util/transport/Response;)V
    ...
    .line 471
    .local v3, pad:I
    iget v7, v4, Ljcifs/smb/ServerMessageBlock;->byteCount:I
    ...
    :try_end_e7
    .catchall {:try_start_4f .. :try_end_e7} :catchall_4c
...
.method send(Ljcifs/smb/ServerMessageBlock;Ljcifs/smb/ServerMessageBlock;)V
    ...
    :try_end_35
    .catch Ljcifs/smb/SmbException; {:try_start_1a .. :try_end_35} :catch_ac
    ...
    .line 580
    iget v9, v2, Ljcifs/smb/ServerMessageBlock;->errorCode:I
    ...
    monitor-enter p0
    :try_end_57
    .catchall {:try_start_35 .. :try_end_57} :catchall_a0
    ...
    iput-boolean v9, v5, Ljcifs/util/transport/Response;->isReceived:Z
    :try_end_5d
    .catchall {:try_start_58 .. :try_end_5d} :catchall_ea

    .line 592
    :try_start_5d
    iget-object v9, p0, Ljcifs/util/transport/Transport;->response_map:Ljava/util/HashMap;
    ...
    iput-wide v9, v5, Ljcifs/util/transport/Response;->expiration:J
    ...
    :try_end_88
    .catchall {:try_start_5d .. :try_end_88} :catchall_e3
    .catch Ljava/lang/InterruptedException; {:try_start_5d .. :try_end_88} :catch_dc
    ...
    monitor-exit p0
    :try_end_8e
    .catchall {:try_start_88 .. :try_end_8e} :catchall_ea
    ...
    invoke-static {v9}, Ljcifs/smb/BufferCache;->releaseBuffer([B)V
    :try_end_98
    .catch Ljcifs/smb/SmbException; {:try_start_8e .. :try_end_98} :catch_ac
    .catch Ljava/io/IOException; {:try_start_8e .. :try_end_98} :catch_f8
    ...
    throw v9
    :try_end_ac
    .catch Ljcifs/smb/SmbException; {:try_start_a1 .. :try_end_ac} :catch_ac
    .catch Ljava/io/IOException; {:try_start_a1 .. :try_end_ac} :catch_f8
    ...
    .line 610
    iget-wide v9, v5, Ljcifs/util/transport/Response;->expiration:J
    ...
    throw v9
    :try_end_dc
    .catchall {:try_start_ae .. :try_end_dc} :catchall_e3
    .catch Ljava/lang/InterruptedException; {:try_start_ae .. :try_end_dc} :catch_dc
    ...
    throw v9
    :try_end_e3
    .catchall {:try_start_dd .. :try_end_e3} :catchall_e3
    ...
    .line 623
    :try_start_e4
    iget-object v10, p0, Ljcifs/util/transport/Transport;->response_map:Ljava/util/HashMap;
    ...
    throw v9
    :try_end_ed
    .catchall {:try_start_ec .. :try_end_ed} :catchall_a0
    ...
    :try_end_f7
    .catch Ljcifs/smb/SmbException; {:try_start_ed .. :try_end_f7} :catch_ac
...
.method ssn139()V
    ...
    :try_end_61
    .catch Ljava/io/IOException; {:try_start_5c .. :try_end_61} :catch_ec
