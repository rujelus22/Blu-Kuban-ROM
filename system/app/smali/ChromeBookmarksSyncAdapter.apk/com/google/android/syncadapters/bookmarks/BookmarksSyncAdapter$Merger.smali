...
.method public run()V
    ...
    :try_end_30
    .catchall {:try_start_3 .. :try_end_30} :catchall_18b
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_30} :catch_98
    .catch Landroid/content/OperationApplicationException; {:try_start_3 .. :try_end_30} :catch_d7
    .catch Ljava/lang/InterruptedException; {:try_start_3 .. :try_end_30} :catch_10b
    .catch Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter$ChromeProtocolException; {:try_start_3 .. :try_end_30} :catch_123
    .catch Ljava/lang/RuntimeException; {:try_start_3 .. :try_end_30} :catch_157
    ...
    :try_end_97
    .catchall {:try_start_3b .. :try_end_97} :catchall_18b
    .catch Landroid/os/RemoteException; {:try_start_3b .. :try_end_97} :catch_98
    .catch Landroid/content/OperationApplicationException; {:try_start_3b .. :try_end_97} :catch_d7
    .catch Ljava/lang/InterruptedException; {:try_start_3b .. :try_end_97} :catch_10b
    .catch Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter$ChromeProtocolException; {:try_start_3b .. :try_end_97} :catch_123
    .catch Ljava/lang/RuntimeException; {:try_start_3b .. :try_end_97} :catch_157
    ...
    :try_end_c0
    .catchall {:try_start_99 .. :try_end_c0} :catchall_18b
    ...
    :try_end_d5
    .catchall {:try_start_cc .. :try_end_d5} :catchall_18b
    .catch Landroid/os/RemoteException; {:try_start_cc .. :try_end_d5} :catch_98
    .catch Landroid/content/OperationApplicationException; {:try_start_cc .. :try_end_d5} :catch_d7
    .catch Ljava/lang/InterruptedException; {:try_start_cc .. :try_end_d5} :catch_10b
    .catch Lcom/google/android/syncadapters/bookmarks/BookmarksSyncAdapter$ChromeProtocolException; {:try_start_cc .. :try_end_d5} :catch_123
    .catch Ljava/lang/RuntimeException; {:try_start_cc .. :try_end_d5} :catch_157
    ...
    invoke-static {v9, v4, v2}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_ff
    .catchall {:try_start_d8 .. :try_end_ff} :catchall_18b
    ...
    :try_end_117
    .catchall {:try_start_10c .. :try_end_117} :catchall_18b
    ...
    invoke-static {v9, v4, v2}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_14b
    .catchall {:try_start_124 .. :try_end_14b} :catchall_18b
    ...
    invoke-static {v9, v4, v2}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_17f
    .catchall {:try_start_158 .. :try_end_17f} :catchall_18b
