...
.method public getMessageDispostion()Ljava/lang/String;
    .registers 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/emailcommon/mail/MessagingException;
    ...
    .line 292
    .local v1, msgDispoTo:Ljava/lang/String;
    :try_start_1
    const-string v2, "Disposition-Notification-To"

    invoke-virtual {p0, v2}, Lcom/android/emailcommon/internet/MimeMessage;->getHeader(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :try_end_d
    .catch Lcom/android/emailcommon/mail/MessagingException; {:try_start_1 .. :try_end_d} :catch_12
    ...
    .line 301
    .end local v1           #msgDispoTo:Ljava/lang/String;
    :cond_11
    return-object v1

    .line 293
    .restart local v1       #msgDispoTo:Ljava/lang/String;
    :catch_12
    move-exception v0
...
.method public getReturnPath()Ljava/lang/String;
    ...
    .line 307
    .local v1, returnRcptTo:Ljava/lang/String;
    :try_start_1
    ...
    .line 317
    .end local v1           #returnRcptTo:Ljava/lang/String;
    :cond_11
    return-object v1

    .line 308
    .restart local v1       #returnRcptTo:Ljava/lang/String;
    :catch_12
    move-exception v0
