...
.method public constructor <init>(Ljava/io/InputStream;I)V
    ...
    iput-object v0, p0, Lbv/e;->d:Ljava/lang/Object;

    iput-object p1, p0, Lbv/e;->a:Ljava/io/InputStream;

    iput p2, p0, Lbv/e;->c:I
...
.method private a([BII)I
    ...
    :try_start_5
    iget-object v0, p0, Lbv/e;->a:Ljava/io/InputStream;
...
.method private c()V
    ...
    iget-object v1, p0, Lbv/e;->d:Ljava/lang/Object;

    monitor-enter v1

    :try_start_3
    iget-boolean v0, p0, Lbv/e;->e:Z

    if-nez v0, :cond_f

    const/4 v0, 0x1

    iput-boolean v0, p0, Lbv/e;->e:Z

    iget-object v0, p0, Lbv/e;->d:Ljava/lang/Object;
...
.method public b()V
    ...
    :try_start_1
    iget v0, p0, Lbv/e;->c:I

    if-eqz v0, :cond_9

    iget-object v0, p0, Lbv/e;->b:Lbv/b;
    ...
    invoke-direct {v0, v1}, Lbv/b;-><init>(I)V

    iput-object v0, p0, Lbv/e;->b:Lbv/b;
    ...
    invoke-direct {p0, v0, v1, v2}, Lbv/e;->a([BII)I

    move-result v1

    if-lez v1, :cond_40

    iget-object v2, p0, Lbv/e;->b:Lbv/b;

    invoke-virtual {v2, v0, v1}, Lbv/b;->a([BI)V
    :try_end_30
    ...
    invoke-static {v1, v0}, LP/e;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_37
    ...
    iget-object v1, p0, Lbv/e;->b:Lbv/b;

    invoke-virtual {v1}, Lbv/b;->b()V
...
.method public declared-synchronized close()V
    ...
    :cond_4
    invoke-virtual {p0}, Lbv/e;->read()I
    :try_end_7
...
.method public read([B)I
    ...
    invoke-virtual {p0, p1, v0, v1}, Lbv/e;->read([BII)I
...
.method public declared-synchronized read([BII)I
    ...
    invoke-virtual {v0, p1, p2, p3}, Lbv/b;->a([BII)I
    :try_end_a
    .catchall {:try_start_1 .. :try_end_a} :catchall_12
    ...
    :cond_d
    :try_start_d
    invoke-direct {p0, p1, p2, p3}, Lbv/e;->a([BII)I
    :try_end_10
    .catchall {:try_start_d .. :try_end_10} :catchall_12
