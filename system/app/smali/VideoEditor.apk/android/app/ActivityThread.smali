...
.method private attach(Z)V
    ...
    :try_end_28
    .catch Landroid/os/RemoteException; {:try_start_23 .. :try_end_28} :catch_7b
...
.method private getExistingProvider(Landroid/content/Context;Ljava/lang/String;)Landroid/content/IContentProvider;
    .registers 6
    .parameter "context"
    .parameter "name"
    ...
    .line 3987
    iget-object v1, v0, Landroid/app/ActivityThread$ProviderClientRecord;->mProvider:Landroid/content/IContentProvider;
...
.method private getProvider(Landroid/content/Context;Ljava/lang/String;)Landroid/content/IContentProvider;
    .registers 11
    .parameter "context"
    .parameter "name"
    ...
    .line 4022
    .end local v0           #existing:Landroid/content/IContentProvider;
    :goto_6
    return-object v0

    .line 3999
    .restart local v0       #existing:Landroid/content/IContentProvider;
    :cond_7
    const/4 v1, 0x0
    ...
    :try_end_13
    .catch Landroid/os/RemoteException; {:try_start_8 .. :try_end_13} :catch_5a
    ...
    monitor-exit v4
    :try_end_59
    .catchall {:try_start_44 .. :try_end_59} :catchall_57
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    :try_end_129
    .catch Landroid/os/RemoteException; {:try_start_11f .. :try_end_129} :catch_378
    ...
    invoke-interface {v0, v2, v4}, Landroid/app/IActivityManager;->showWaitingForDebugger(Landroid/app/IApplicationThread;Z)V
    :try_end_136
    .catch Landroid/os/RemoteException; {:try_start_12c .. :try_end_136} :catch_375
    ...
    :try_end_147
    .catch Landroid/os/RemoteException; {:try_start_140 .. :try_end_147} :catch_372
    ...
    :try_end_16a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_15e .. :try_end_16a} :catch_36f
    ...
    :try_end_227
    .catch Ljava/lang/Exception; {:try_start_20d .. :try_end_227} :catch_2d2
    ...
    :try_end_287
    .catch Ljava/lang/Exception; {:try_start_27c .. :try_end_287} :catch_2fe
    ...
    :try_end_2d1
    .catch Ljava/lang/Exception; {:try_start_2ca .. :try_end_2d1} :catch_335
...
.method private installProvider(Landroid/content/Context;Landroid/content/IContentProvider;Landroid/content/pm/ProviderInfo;Z)Landroid/content/IContentProvider;
    .registers 19
    .parameter "context"
    .parameter "provider"
    .parameter "info"
    ...
    const-string v11, "Loading provider "
    ...
    :try_end_88
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_82 .. :try_end_88} :catch_15b
    ...
    iget-object v9, v0, Landroid/content/pm/ProviderInfo;->name:Ljava/lang/String;
    ...
    .line 4188
    invoke-virtual {v6}, Landroid/content/ContentProvider;->getIContentProvider()Landroid/content/IContentProvider;
    ...
    invoke-virtual {v6, v2, v0}, Landroid/content/ContentProvider;->attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    :try_end_d7
    .catch Ljava/lang/Exception; {:try_start_8a .. :try_end_d7} :catch_103
    ...
    .line 4214
    :try_start_da
    sget-object v9, Landroid/app/ActivityThread;->PATTERN_SEMICOLON:Ljava/util/regex/Pattern;
    ...
    .line 4216
    new-instance v8, Landroid/app/ActivityThread$ProviderClientRecord;

    aget-object v9, v7, v5

    move-object/from16 v0, p2

    invoke-direct {v8, p0, v9, v0, v6}, Landroid/app/ActivityThread$ProviderClientRecord;-><init>(Landroid/app/ActivityThread;Ljava/lang/String;Landroid/content/IContentProvider;Landroid/content/ContentProvider;)V
    :try_end_f1
    .catchall {:try_start_da .. :try_end_f1} :catchall_140
    ...
    invoke-interface {v9, v8, v11}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    ...
    :try_end_100
    .catchall {:try_start_f1 .. :try_end_100} :catchall_140
    .catch Landroid/os/RemoteException; {:try_start_f1 .. :try_end_100} :catch_13b
    ...
    invoke-virtual {v9, v10, v4}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    .restart local v8       #pr:Landroid/app/ActivityThread$ProviderClientRecord;
    :catch_13b
    move-exception v4
    ...
    monitor-exit v10
    :try_end_142
    .catchall {:try_start_13d .. :try_end_142} :catchall_140
    ...
    invoke-direct {v12, p0, v13, v0, v6}, Landroid/app/ActivityThread$ProviderClientRecord;-><init>(Landroid/app/ActivityThread;Ljava/lang/String;Landroid/content/IContentProvider;Landroid/content/ContentProvider;)V
    ...
    monitor-exit v10
    :try_end_157
    .catchall {:try_start_145 .. :try_end_157} :catchall_140
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    :try_end_4c
    .catch Ljava/lang/Exception; {:try_start_3e .. :try_end_4c} :catch_76
    ...
    invoke-virtual {v2}, Landroid/app/Activity;->performStop()V
    :try_end_71
    .catch Ljava/lang/Exception; {:try_start_6c .. :try_end_71} :catch_b5
