...
.method private handleIccCardStatus(Lcom/android/internal/telephony/IccCardStatus;)V
    ...
    .line 562
    iget-boolean v9, p0, Lcom/android/internal/telephony/IccCard;->mRequestSetPINLock:Z
    ...
    iput-boolean v9, p0, Lcom/android/internal/telephony/IccCard;->mRequestSetPINLock:Z

    .line 564
    iget-object v9, p0, Lcom/android/internal/telephony/IccCard;->arForChangeToPUKState:Landroid/os/AsyncResult;
    ...
    iget-object v9, v9, Landroid/os/AsyncResult;->userObj:Ljava/lang/Object;
    ...
    iget-object v10, v10, Landroid/os/AsyncResult;->exception:Ljava/lang/Throwable;
    ...
    .line 573
    :cond_37
    iget-boolean v9, p0, Lcom/android/internal/telephony/IccCard;->mReadEcc:Z
    ...
    iget-object v9, v9, Lcom/android/internal/telephony/PhoneBase;->mIccFileHandler:Lcom/android/internal/telephony/IccFileHandler;
    ...
    invoke-virtual {v9, v10, v11}, Lcom/android/internal/telephony/IccFileHandler;->loadEFLinearFixedAll(ILandroid/os/Message;)V

    .line 581
    const/4 v9, 0x1

    iput-boolean v9, p0, Lcom/android/internal/telephony/IccCard;->mReadEcc:Z
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/IccCard;->mEmergencyNumber:Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/gsm/GSMPhone;->setEmergencyNumbers()V
    ...
    if-eq v3, v9, :cond_131

    sget-object v9, Lcom/android/internal/telephony/IccCard$State;->ABSENT:Lcom/android/internal/telephony/IccCard$State;

    if-ne v2, v9, :cond_131
    ...
    .line 624
    iget-boolean v9, p0, Lcom/android/internal/telephony/IccCard;->mDesiredPinLocked:Z
...
.method private readEcclist()V
    ...
    :try_end_17
    .catchall {:try_start_2 .. :try_end_17} :catchall_ee
    .catch Ljava/io/FileNotFoundException; {:try_start_2 .. :try_end_17} :catch_7d
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_17} :catch_b7
    ...
    :try_end_1c
    .catch Ljava/lang/Exception; {:try_start_19 .. :try_end_1c} :catch_10f
    ...
    :try_end_29
    .catchall {:try_start_1d .. :try_end_29} :catchall_ee
    .catch Ljava/io/FileNotFoundException; {:try_start_1d .. :try_end_29} :catch_7d
    .catch Ljava/io/IOException; {:try_start_1d .. :try_end_29} :catch_b7
    ...
    :try_end_30
    .catch Ljava/lang/Exception; {:try_start_2d .. :try_end_30} :catch_126
    ...
    invoke-static {v6, v7}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_76
    .catchall {:try_start_32 .. :try_end_76} :catchall_15c
    .catch Ljava/io/FileNotFoundException; {:try_start_32 .. :try_end_76} :catch_163
    .catch Ljava/io/IOException; {:try_start_32 .. :try_end_76} :catch_15f
    ...
    invoke-virtual {v4}, Ljava/io/BufferedReader;->close()V
    :try_end_7b
    .catch Ljava/lang/Exception; {:try_start_78 .. :try_end_7b} :catch_141
    ...
    :try_end_96
    .catchall {:try_start_7e .. :try_end_96} :catchall_ee
    ...
    invoke-static {v6, v7}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_d0
    .catchall {:try_start_b8 .. :try_end_d0} :catchall_ee
