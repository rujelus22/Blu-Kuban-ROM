...
.method private dismissRescanDialog()V
    ...
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_11} :catch_14
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->getNitzTimeZone(IZJ)Ljava/util/TimeZone;
    :try_end_2d0
    .catch Ljava/lang/RuntimeException; {:try_start_72 .. :try_end_2d0} :catch_31c
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->log(Ljava/lang/String;)V
    :try_end_312
    .catchall {:try_start_2d9 .. :try_end_312} :catchall_40d
    ...
    :try_end_31b
    .catch Ljava/lang/RuntimeException; {:try_start_312 .. :try_end_31b} :catch_31c
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->log(Ljava/lang/String;)V
    :try_end_375
    .catchall {:try_start_350 .. :try_end_375} :catchall_40d
    ...
    invoke-virtual/range {v30 .. v30}, Landroid/os/PowerManager$WakeLock;->release()V
    :try_end_37e
    .catch Ljava/lang/RuntimeException; {:try_start_375 .. :try_end_37e} :catch_31c
    ...
    :try_end_402
    .catchall {:try_start_385 .. :try_end_402} :catchall_40d
    ...
    throw v30
    :try_end_418
    .catch Ljava/lang/RuntimeException; {:try_start_402 .. :try_end_418} :catch_31c
.end method
...
.method protected updateSpnDisplay()V
    ...
    const-string/jumbo v12, "updateSpnDisplay(); mEmergencyOnly: "
    ...
    const-string v12, ", mRilRegState: "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mRilRegState:I

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, ", mLuRejCause: "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mLuRejCause:I
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/gsm/SIMRecords;->getIMSI()Ljava/lang/String;
    ...
    if-ne v10, v13, :cond_e8

    :cond_e4
    iget-boolean v10, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->after2min:Z
