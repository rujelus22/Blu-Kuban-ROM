...
.method private postscan([Ljava/lang/String;)V
    ...
    const-string/jumbo v11, "postscan enter: directories - "
    ...
    const-string v10, "Device is shutting down!! return postscan. Do not need to call MediaProvider.delete()"
    ...
    .line 1437
    iget-object v9, p0, Landroid/media/MediaScanner;->mMediaDeleter:Landroid/media/MediaDeleter;
    ...
    invoke-virtual {v9, v10, v8}, Landroid/media/MediaDeleter;->delete(Landroid/net/Uri;Landroid/content/ContentValues;)V
    ...
    const-string v10, "call pruneDeadThumbnailFiles()"
    ...
    const-string/jumbo v10, "postscan return"
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1496
    .local v11, isScanningExternal:Z
    const/16 v19, 0x0
    ...
    invoke-direct/range {v19 .. v21}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;I)V
    ...
    .line 1502
    new-instance v19, Landroid/media/MediaUpdater;
    ...
    invoke-direct/range {v19 .. v21}, Landroid/media/MediaUpdater;-><init>(Landroid/content/IContentProvider;I)V
    ...
    .line 1503
    new-instance v19, Landroid/media/MediaDeleter;
    ...
    invoke-direct/range {v19 .. v21}, Landroid/media/MediaDeleter;-><init>(Landroid/content/IContentProvider;I)V
    ...
    const-string v19, "/mnt/sdcard/external_sd"
    ...
    invoke-virtual {v0, v1, v2}, Landroid/media/MediaScanner;->setSdCardPathsToNative(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v21, "scanDirectory [#"
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/media/MediaUpdater;->flush()V
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/media/MediaDeleter;->flush()V
    ...
    invoke-virtual/range {v19 .. v20}, Landroid/media/MediaInserter;->getCount(Landroid/net/Uri;)I

    move-result v9

    .line 1530
    .local v9, insertedImage:I
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/media/MediaUpdater;->getCount()I
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/media/MediaDeleter;->getCount()I
    ...
    const-string v21, "  scanned file: Audio "
    ...
    const-string v21, "  updated file: Audio "
    ...
    .line 1549
    .end local v3           #deleted:I
    .end local v7           #insertedAudio:I
    .end local v8           #insertedFile:I
    .end local v9           #insertedImage:I
    .end local v10           #insertedVideo:I
    ...
    const-string/jumbo v21, "ms (Audio/Video parsing : "
    ...
    const-string/jumbo v21, "ms, Image parsing : "
    ...
    sput-boolean v19, Landroid/media/MediaScanner;->bIsUpdatingAudioMetadata:Z
    :try_end_2ba
    .catch Landroid/database/SQLException; {:try_start_0 .. :try_end_2ba} :catch_2bf
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_2ba} :catch_2bd
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_2ba} :catch_2bb

    .line 1568
    .end local v4           #end:J
    .end local v6           #i:I
    .end local v11           #isScanningExternal:Z
