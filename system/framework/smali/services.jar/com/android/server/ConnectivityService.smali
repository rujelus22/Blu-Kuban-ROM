...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    invoke-interface {v4, v2}, Landroid/os/INetworkManagementService;->registerObserver(Landroid/net/INetworkManagementEventObserver;)V
    :try_end_5cc
    .catch Landroid/os/RemoteException; {:try_start_5be .. :try_end_5cc} :catch_5f5
...
.method private addRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;)Z
    .registers 9
    .parameter "p"
    .parameter "r"
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/ConnectivityService;->modifyRoute(Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/RouteInfo;IZ)Z
...
.method private addRouteToAddress(Landroid/net/LinkProperties;Ljava/net/InetAddress;)Z
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/ConnectivityService;->modifyRouteToAddress(Landroid/net/LinkProperties;Ljava/net/InetAddress;Z)Z
...
.method private handleConnect(Landroid/net/NetworkInfo;)V
    ...
    monitor-exit p0
    :try_end_93
    .catchall {:try_start_78 .. :try_end_93} :catchall_c8
...
.method private makeWimaxStateTracker()Landroid/net/NetworkStateTracker;
    ...
    .line 617
    .local v0, NET_4G_WIMAX_SERVICE:Ljava/lang/String;
    new-instance v2, Landroid/net/fourG/wimax/WimaxStateTracker;

    const/4 v3, 0x6

    const-string v4, "WIMAX"

    invoke-direct {v2, v3, v4}, Landroid/net/fourG/wimax/WimaxStateTracker;-><init>(ILjava/lang/String;)V

    .line 618
    .local v2, wimaxStateTracker:Landroid/net/fourG/wimax/WimaxStateTracker;
    new-instance v1, Lcom/android/server/WimaxService;

    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mContext:Landroid/content/Context;

    invoke-direct {v1, v3, v2}, Lcom/android/server/WimaxService;-><init>(Landroid/content/Context;Landroid/net/fourG/wimax/WimaxStateTracker;)V

    .line 619
    .local v1, wimaxService:Lcom/android/server/WimaxService;
...
.method private modifyRoute(Ljava/lang/String;Landroid/net/LinkProperties;Landroid/net/RouteInfo;IZ)Z
    .registers 14
    .parameter "ifaceName"
    .parameter "lp"
    .parameter "r"
    ...
    .line 1283
    const-string v0, "Error adding route - too much recursion"
...
.method private modifyRouteToAddress(Landroid/net/LinkProperties;Ljava/net/InetAddress;Z)Z
    .registers 10
    .parameter "lp"
    .parameter "addr"
    .parameter "doAdd"
...
.method private removeRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;)Z
    .registers 9
    .parameter "p"
    .parameter "r"
...
.method private setConnectivitySystemProperty(Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v2, v3}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_35
    .catch Landroid/os/RemoteException; {:try_start_21 .. :try_end_35} :catch_63
    .catch Ljava/lang/RuntimeException; {:try_start_21 .. :try_end_35} :catch_7d
    ...
    const-string v4, "setConnectivitySystemProperty : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, "net.connectivity.type"
    ...
    .catch Ljava/lang/RuntimeException; {:try_start_54 .. :try_end_62} :catch_7d
    ...
    const-string v4, "setConnectivitySystemProperty RemoteException"
    ...
    const-string v4, "setConnectivitySystemProperty RuntimeException"
    ...
    const-string v3, "net.connectivity.type WIMAX"
    ...
    const-string v3, "net.connectivity.type WIFI"
...
.method private updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Z)Z
    ...
    :cond_15
    :goto_15
    iget-object v9, v6, Landroid/net/LinkProperties$CompareResult;->removed:Ljava/util/Collection;
    ...
    iget-object v9, v6, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    .line 1970
    :cond_40
    invoke-direct {p0, p2, v5}, Lcom/android/server/ConnectivityService;->removeRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;)Z
    ...
    iput-object v9, v6, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    iput-object v9, v0, Landroid/net/LinkProperties$CompareResult;->added:Ljava/util/Collection;
    ...
    .line 1976
    :cond_6f
    invoke-direct {p0, p1, v5}, Lcom/android/server/ConnectivityService;->addRoute(Landroid/net/LinkProperties;Landroid/net/RouteInfo;)Z
    ...
    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mAddedRoutes:Ljava/util/Collection;
    ...
    invoke-interface {v9, v2, v5}, Landroid/os/INetworkManagementService;->removeRoute(Ljava/lang/String;Landroid/net/RouteInfo;)V
    :try_end_8a
...
.method public getDhcpServerConfiguration()Landroid/net/DhcpServerConfiguration;
    ...
    const-string v4, "getDhcpServerConfiguration()"
    ...
    .line 2864
    .local v0, cr:Landroid/content/ContentResolver;
    new-instance v2, Landroid/net/DhcpServerConfiguration;

    invoke-direct {v2}, Landroid/net/DhcpServerConfiguration;-><init>()V

    .line 2866
    .local v2, serverConfig:Landroid/net/DhcpServerConfiguration;
    :try_start_12
    const-string v3, "wifiap_local_ip"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Landroid/net/DhcpServerConfiguration;->localIp:Ljava/lang/String;
    ...
    const-string v5, "serverConfig.localIp "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, v2, Landroid/net/DhcpServerConfiguration;->localIp:Ljava/lang/String;
    ...
    .line 2868
    const-string v3, "wifiap_subnet_mask"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Landroid/net/DhcpServerConfiguration;->subnetmask:Ljava/lang/String;
    ...
    const-string v5, "serverConfig.subnetmask "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, v2, Landroid/net/DhcpServerConfiguration;->subnetmask:Ljava/lang/String;
    ...
    :goto_5f
    iput-boolean v3, v2, Landroid/net/DhcpServerConfiguration;->dhcpEnable:Z
    ...
    const-string v5, "serverConfig.dhcpEnable "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, v2, Landroid/net/DhcpServerConfiguration;->dhcpEnable:Z
    ...
    .line 2872
    const-string v3, "wifiap_dhcp_start_ip"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Landroid/net/DhcpServerConfiguration;->ipRangeStart:Ljava/lang/String;
    ...
    const-string v5, "serverConfig.ipRangeStart "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, v2, Landroid/net/DhcpServerConfiguration;->ipRangeStart:Ljava/lang/String;
    ...
    .line 2874
    const-string v3, "wifiap_dhcp_end_ip"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Landroid/net/DhcpServerConfiguration;->ipRangeEnd:Ljava/lang/String;
    ...
    const-string v5, "serverConfig.ipRangeEnd "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, v2, Landroid/net/DhcpServerConfiguration;->ipRangeEnd:Ljava/lang/String;
    ...
    .line 2876
    const-string v3, "wifiap_dhcp_lease_time"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I

    move-result v3

    iput v3, v2, Landroid/net/DhcpServerConfiguration;->leaseTime:I
    ...
    const-string v5, "serverConfig.leaseTime "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Landroid/net/DhcpServerConfiguration;->leaseTime:I
    ...
    .line 2878
    const-string v3, "wifiap_dhcp_max_user"

    invoke-static {v0, v3}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I

    move-result v3

    iput v3, v2, Landroid/net/DhcpServerConfiguration;->maxClient:I
    ...
    const-string v5, "serverConfig.maxClient "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget v5, v2, Landroid/net/DhcpServerConfiguration;->maxClient:I
    ...
    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_103
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_12 .. :try_end_103} :catch_107

    .line 2884
    .end local v2           #serverConfig:Landroid/net/DhcpServerConfiguration;
    :goto_103
    return-object v2

    .line 2870
    .restart local v2       #serverConfig:Landroid/net/DhcpServerConfiguration;
    :cond_104
    const/4 v3, 0x0
    ...
    const-string v4, "getWifiApProfileConfiguration AP settings not found, returning"
...
.method public isTetheringSupported()Z
    ...
    .line 2555
    const-string v9, "ro.tether.denied"
    ...
    const-string v10, "tether_supported"
    ...
    .line 2560
    .local v5, tetherEnabledInSettings:Z
    :goto_23
    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mTethering:Lcom/android/server/connectivity/Tethering;

    invoke-virtual {v9}, Lcom/android/server/connectivity/Tethering;->getUpstreamIfaceTypes()[I

    move-result-object v6

    .line 2561
    .local v6, upstreamConnTypes:[I
    move-object v0, v6
    ...
    .end local v3           #i$:I
    .end local v4           #len$:I
    .end local v5           #tetherEnabledInSettings:Z
    .end local v6           #upstreamConnTypes:[I
    :cond_34
    move v1, v8
    ...
    .restart local v5       #tetherEnabledInSettings:Z
    .restart local v6       #upstreamConnTypes:[I
    :cond_38
    add-int/lit8 v3, v3, 0x1
    ...
    iget-boolean v9, p0, Lcom/android/server/ConnectivityService;->mTetheringConfigValid:Z
...
.method public protectVpn(Landroid/os/ParcelFileDescriptor;)Z
    ...
    :try_end_1d
    .catch Ljava/lang/Exception; {:try_start_1a .. :try_end_1d} :catch_2f
    ...
    invoke-virtual {p1}, Landroid/os/ParcelFileDescriptor;->close()V
    :try_end_21
    .catch Ljava/lang/Exception; {:try_start_1e .. :try_end_21} :catch_31
...
.method public declared-synchronized setRoamingMobileDataEnabled(Z)V
    ...
    :try_end_94
    .catchall {:try_start_5c .. :try_end_94} :catchall_59
