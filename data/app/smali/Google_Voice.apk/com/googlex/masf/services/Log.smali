.class public Lcom/googlex/masf/services/Log;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/googlex/masf/services/Log$LogRecord;
    }
.end annotation
...
.field private static final logEntries:[Lcom/googlex/masf/services/Log$LogRecord;
...
.method static constructor <clinit>()V
    ...
    sput v1, Lcom/googlex/masf/services/Log;->uploadEntries:I

    new-array v1, v3, [Lcom/googlex/masf/services/Log$LogRecord;

    sput-object v1, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;

    sput v0, Lcom/googlex/masf/services/Log;->logEntryFirst:I

    sput v0, Lcom/googlex/masf/services/Log;->logEntryNext:I

    sput v0, Lcom/googlex/masf/services/Log;->logEntryCount:I

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    sput-object v1, Lcom/googlex/masf/services/Log;->uploadCompleteLock:Ljava/lang/Object;

    new-instance v1, Ljava/util/Hashtable;

    invoke-direct {v1}, Ljava/util/Hashtable;-><init>()V

    sput-object v1, Lcom/googlex/masf/services/Log;->timers:Ljava/util/Hashtable;

    :goto_1f
    if-ge v0, v3, :cond_2d

    sget-object v1, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;

    new-instance v2, Lcom/googlex/masf/services/Log$LogRecord;

    invoke-direct {v2}, Lcom/googlex/masf/services/Log$LogRecord;-><init>()V
    ...
    sput-object v0, Lcom/googlex/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/googlex/masf/services/Log;->lastEventTimeMillis:J
...
.method public static addEvent(SLjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/googlex/masf/services/Log;->getPersistentStore()Lcom/googlex/common/io/PersistentStore;

    move-result-object v1

    const-string v0, "EVENT_LOG"

    invoke-interface {v1, v0}, Lcom/googlex/common/io/PersistentStore;->readPreference(Ljava/lang/String;)[B

    move-result-object v0

    if-nez v0, :cond_6e

    invoke-static {v4, v5}, Lcom/googlex/masf/services/Log;->resetEventLog(J)V
    ...
    sget-wide v0, Lcom/googlex/masf/services/Log;->lastEventTimeMillis:J
    ...
    invoke-interface {v0, v1, v6}, Lcom/googlex/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z

    sput-wide v4, Lcom/googlex/masf/services/Log;->lastEventTimeMillis:J
    :try_end_6c
    .catch Ljava/io/IOException; {:try_start_38 .. :try_end_6c} :catch_7d
    ...
    invoke-static {}, Lcom/googlex/masf/services/Log;->uploadEventLog()V
...
.method public static addExceptionString(Ljava/lang/String;)V
    ...
    :cond_4
    sget-object v2, Lcom/googlex/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;

    monitor-enter v2

    :try_start_7
    sget-object v1, Lcom/googlex/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;
    ...
    :cond_1e
    sget-object v0, Lcom/googlex/masf/services/Log;->lastExceptionString:Ljava/lang/StringBuffer;
...
.method private static addLogEntry(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v0, Lcom/googlex/masf/services/Log;->logEntryCount:I
    ...
    :cond_e
    sget-object v0, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;

    sget v1, Lcom/googlex/masf/services/Log;->logEntryNext:I
    ...
    iput-wide v1, v0, Lcom/googlex/masf/services/Log$LogRecord;->timestamp:J

    iput-object p0, v0, Lcom/googlex/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object p1, v0, Lcom/googlex/masf/services/Log$LogRecord;->description:Ljava/lang/String;
    ...
    sget v0, Lcom/googlex/masf/services/Log;->logEntryNext:I
...
.method public static clear()V
    ...
    :try_start_3
    invoke-static {}, Lcom/googlex/masf/services/Log;->clearLogEntries()V
...
.method private static clearLogEntries()V
    ...
    iput-wide v2, v1, Lcom/googlex/masf/services/Log$LogRecord;->timestamp:J

    iput-object v4, v1, Lcom/googlex/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object v4, v1, Lcom/googlex/masf/services/Log$LogRecord;->description:Ljava/lang/String;
...
.method public static endTimer(Ljava/lang/String;)J
    ...
    sget-object v0, Lcom/googlex/masf/services/Log;->timers:Ljava/util/Hashtable;
    ...
    invoke-static {v0}, Lcom/googlex/masf/services/Log;->log(Ljava/lang/String;)V
...
.method public static endTimerAndLog(Ljava/lang/String;Ljava/lang/String;)J
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/googlex/masf/services/Log;->endTimerAndLogConditionally(Ljava/lang/String;Ljava/lang/String;J)J
...
.method public static endTimerAndLogConditionally(Ljava/lang/String;Ljava/lang/String;J)J
    ...
    invoke-static {p1}, Lcom/googlex/masf/services/Log;->endTimer(Ljava/lang/String;)J
    ...
    invoke-static {p0, v2}, Lcom/googlex/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static getLog()Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/googlex/masf/services/Log;->getLog(I)Ljava/lang/String;
...
.method public static getLog(I)Ljava/lang/String;
    ...
    sget-object v3, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;
    ...
    sget v0, Lcom/googlex/masf/services/Log;->logEntryFirst:I
    ...
    invoke-virtual {v1, v4}, Lcom/googlex/masf/services/Log$LogRecord;->appendToBuffer(Ljava/lang/StringBuffer;)Ljava/lang/StringBuffer;
...
.method public static getLogEntries()Ljava/util/Vector;
    ...
    :goto_a
    sget v4, Lcom/googlex/masf/services/Log;->logEntryCount:I

    if-ge v0, v4, :cond_23

    sget-object v4, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;

    aget-object v4, v4, v2

    invoke-virtual {v4}, Lcom/googlex/masf/services/Log$LogRecord;->toString()Ljava/lang/String;
...
.method public static log(Ljava/lang/String;)V
    ...
    invoke-static {v0, p0}, Lcom/googlex/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_3
    invoke-static {p0, p1}, Lcom/googlex/masf/services/Log;->addLogEntry(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/googlex/masf/services/Log;->truncateLog(I)V
...
.method public static logException(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {v0}, Lcom/googlex/masf/services/Log;->addExceptionString(Ljava/lang/String;)V

    invoke-static {p0, p1}, Lcom/googlex/masf/services/Log;->logQuietException(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static logQuietException(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {p0, v0}, Lcom/googlex/masf/services/Log;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1}, Ljava/lang/Exception;->printStackTrace()V

    invoke-static {p0, p1}, Lcom/googlex/masf/services/Log;->sendException(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static print()V
    ...
    sget-object v5, Lcom/googlex/masf/services/Log;->logEntries:[Lcom/googlex/masf/services/Log$LogRecord;
...
.method private static resetEventLog(J)V
    ...
    sput-wide p0, Lcom/googlex/masf/services/Log;->lastEventTimeMillis:J
    :try_end_13
    ...
    invoke-interface {v0, v2, v1}, Lcom/googlex/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
    ...
    invoke-interface {v2, v3, v1}, Lcom/googlex/common/io/PersistentStore;->setPreference(Ljava/lang/String;[B)Z
...
.method public static setImmediateFlush(Z)V
    ...
    sput-boolean p0, Lcom/googlex/masf/services/Log;->immediateFlush:Z
...
.method public static setUploadEntries(I)V
    ...
    sput p0, Lcom/googlex/masf/services/Log;->uploadEntries:I
...
.method public static startTimer(Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/googlex/masf/services/Log;->timers:Ljava/util/Hashtable;
...
.method private static takeLogEntry()Lcom/googlex/masf/services/Log$LogRecord;
    .registers 3
    ...
    sget v1, Lcom/googlex/masf/services/Log;->logEntryFirst:I

    aget-object v0, v0, v1

    sget v1, Lcom/googlex/masf/services/Log;->logEntryCount:I

    add-int/lit8 v1, v1, -0x1

    sput v1, Lcom/googlex/masf/services/Log;->logEntryCount:I

    sget v1, Lcom/googlex/masf/services/Log;->logEntryFirst:I

    add-int/lit8 v1, v1, 0x1

    sput v1, Lcom/googlex/masf/services/Log;->logEntryFirst:I
...
.method private static truncateLog(I)V
    ...
    invoke-static {}, Lcom/googlex/masf/services/Log;->takeLogEntry()Lcom/googlex/masf/services/Log$LogRecord;

    move-result-object v0

    iput-object v1, v0, Lcom/googlex/masf/services/Log$LogRecord;->source:Ljava/lang/String;

    iput-object v1, v0, Lcom/googlex/masf/services/Log$LogRecord;->description:Ljava/lang/String;
