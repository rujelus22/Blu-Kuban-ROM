.class public Lcom/googlex/masf/protocol/PlainRequest;
...
.field payloadProvider:Lcom/googlex/masf/InputStreamProvider;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/googlex/masf/protocol/PlainRequest;->setBlockType(I)V
...
.method public constructor <init>(Ljava/lang/String;ILcom/googlex/masf/InputStreamProvider;)V
    ...
    invoke-direct {p0, p3}, Lcom/googlex/masf/protocol/PlainRequest;->setPayloadProvider(Lcom/googlex/masf/InputStreamProvider;)V
...
.method public constructor <init>(Ljava/lang/String;I[B)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/googlex/masf/protocol/PlainRequest;-><init>(Ljava/lang/String;ILcom/googlex/masf/InputStreamProvider;)V
...
.method private generateBlockData()V
    ...
    iget-object v0, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadHeader:[B

    if-nez v0, :cond_7

    invoke-direct {p0}, Lcom/googlex/masf/protocol/PlainRequest;->generatePayloadHeader()V
...
.method private generatePayloadHeader()V
    ...
    invoke-virtual {p0}, Lcom/googlex/masf/protocol/PlainRequest;->getId()I

    move-result v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeShort(I)V

    invoke-virtual {p0}, Lcom/googlex/masf/protocol/PlainRequest;->getServiceUri()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeUTF(Ljava/lang/String;)V

    invoke-virtual {p0}, Lcom/googlex/masf/protocol/PlainRequest;->getServiceVersion()I

    move-result v2

    invoke-virtual {v1, v2}, Ljava/io/DataOutputStream;->writeShort(I)V

    iget-object v2, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadProvider:Lcom/googlex/masf/InputStreamProvider;
    ...
    iput-object v0, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadHeader:[B
...
.method private setPayloadProvider(Lcom/googlex/masf/InputStreamProvider;)V
    ...
    iput-object p1, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadProvider:Lcom/googlex/masf/InputStreamProvider;
...
.method protected declared-synchronized getBodyInputStream()Ljava/io/InputStream;
    ...
    :try_start_1
    invoke-direct {p0}, Lcom/googlex/masf/protocol/PlainRequest;->generateBlockData()V

    iget-object v0, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadProvider:Lcom/googlex/masf/InputStreamProvider;

    if-nez v0, :cond_11

    new-instance v0, Ljava/io/ByteArrayInputStream;

    iget-object v1, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadHeader:[B
    ...
    iget-object v2, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadHeader:[B
...
.method protected declared-synchronized getBodyStreamLength()I
    ...
    iget-object v1, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadProvider:Lcom/googlex/masf/InputStreamProvider;
...
.method public getSendCount()I
    ...
    iget v0, p0, Lcom/googlex/masf/protocol/PlainRequest;->sentCount:I
...
.method public declared-synchronized setPayload([B)V
    ...
    iput-object v0, p0, Lcom/googlex/masf/protocol/PlainRequest;->payloadProvider:Lcom/googlex/masf/InputStreamProvider;
    :try_end_8
