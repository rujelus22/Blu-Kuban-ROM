.class Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;

    .line 126
    new-instance v0, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener$1;

    invoke-direct {v0}, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener$1;-><init>()V

    sput-object v0, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
...
.method public constructor <init>(Landroid/animation/ObjectAnimator;)V
    ...
    .line 29
    iput-object p1, p0, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
...
.method static synthetic access$000(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 21
    invoke-static {p0}, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->remove(Landroid/animation/Animator;)V
...
.method private static remove(Landroid/animation/Animator;)V
    ...
    .prologue
    .line 33
    sget-object v2, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 34
    .local v1, iter:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;>;>;"
    :cond_a
    ...
    .line 36
    .local v0, entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;>;"
    invoke-interface {v0}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;

    iget-object v2, v2, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 43
    .end local v0           #entry:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/Object;Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;>;"
    :cond_23
    return-void
.end method
...
.method private static varargs replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
    ...
    sget-object v5, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;

    invoke-virtual {v5, v2}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;

    .line 152
    .local v4, tween:Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    if-eqz v4, :cond_29

    .line 153
    iget-object v5, v4, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .line 155
    iget-object v6, v4, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    .end local v4           #tween:Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    :cond_32
    return-void
.end method
...
.method public static reset()V
    ...
    .prologue
    .line 146
    sget-object v0, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
...
.method public static varargs to(Ljava/lang/Object;J[Ljava/lang/Object;)Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    .registers 22
    .parameter "object"
    .parameter "duration"
    .parameter "vars"
    ...
    .end local v13           #value:Ljava/lang/Object;
    :cond_fb
    sget-object v14, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    check-cast v11, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;

    .line 85
    .local v11, tween:Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    const/4 v2, 0x0
    ...
    .line 89
    new-instance v11, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;

    .end local v11           #tween:Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    invoke-direct {v11, v2}, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;-><init>(Landroid/animation/ObjectAnimator;)V

    .line 90
    .restart local v11       #tween:Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;
    sget-object v14, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->sTweens:Ljava/util/HashMap;
    ...
    .line 112
    :cond_143
    sget-object v14, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->mCleanupListener:Landroid/animation/Animator$AnimatorListener;
    ...
    check-cast v14, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;

    iget-object v2, v14, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->animator:Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v10, v14}, Lcom/google/android/apps/plus/hangout/multiwaveview/Tweener;->replace(Ljava/util/ArrayList;[Ljava/lang/Object;)V
