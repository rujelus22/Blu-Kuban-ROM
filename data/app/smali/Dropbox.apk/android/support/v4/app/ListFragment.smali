...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/ListFragment;->V:Landroid/os/Handler;

    .line 49
    new-instance v0, Landroid/support/v4/app/u;

    invoke-direct {v0, p0}, Landroid/support/v4/app/u;-><init>(Landroid/support/v4/app/ListFragment;)V

    iput-object v0, p0, Landroid/support/v4/app/ListFragment;->W:Ljava/lang/Runnable;

    .line 55
    new-instance v0, Landroid/support/v4/app/v;

    invoke-direct {v0, p0}, Landroid/support/v4/app/v;-><init>(Landroid/support/v4/app/ListFragment;)V

    iput-object v0, p0, Landroid/support/v4/app/ListFragment;->X:Landroid/widget/AdapterView$OnItemClickListener;
...
.method private a()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->X:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    :cond_32
    :goto_32
    iget-object v0, p0, Landroid/support/v4/app/ListFragment;->V:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v4/app/ListFragment;->W:Ljava/lang/Runnable;
...
.method private a(ZZ)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/ListFragment;->i()Landroid/support/v4/app/FragmentActivity;
